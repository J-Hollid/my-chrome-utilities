...
export function effectiveFlowPageFrameName(project, frame) { return frame.nameInFlow?.trim() || project.collections.pages.find(({ id }) => id === frame.pageId)?.name || frame.pageId; }
