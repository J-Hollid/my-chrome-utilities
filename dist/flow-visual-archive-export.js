...
const sameAssetContract = (left, right) => left.metadata.digest === right.metadata.digest && left.metadata.mediaType === right.metadata.mediaType && left.metadata.byteLength === right.metadata.byteLength;
