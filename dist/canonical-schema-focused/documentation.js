...
export function renderDocumentationFacet(host, context, working) {
    const { dom } = context, display = input(dom, "displayText", working.documentation.displayText), description = dom.createElement("textarea"), comments = dom.createElement("textarea");
