...
export const projectCollectionDefinitions = {
    ...
    pages: { kind: "pages", overview: "Pages", singular: "Page", addAction: "Add Page", purpose: "observable Page context and specific requirements", example: "Cart", prerequisites: ["optional Page Groups"], consumers: ["Flows", "Test cases"] },
...
export const projectCollectionCreationFields = {
    ...
    pages: [{ key: "description", label: "Description", control: "textarea", guidance: "Explain the Page context and intended use." }, { key: "eventName", label: "Page-view event name", guidance: "Required event name emitted when this Page context is observed." }, { key: "pathname", label: "Exact URL path", guidance: "Optional exact pathname beginning with /; host, query, and hash are ignored." }],
