...
export const projectCollectionDefinitions = {
    ...
    pages: { kind: "pages", overview: "Pages", singular: "Page", addAction: "Add Page", purpose: "reusable schema context and specific requirements", example: "Cart", prerequisites: ["optional Page Groups"], consumers: ["Flows", "Test cases", "Assignments"] },
