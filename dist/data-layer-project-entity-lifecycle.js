...
export const projectCollectionDefinitions = {
    ...
    events: { kind: "events", overview: "Events", singular: "Event", addAction: "Add Event", purpose: "reusable interaction or context-setting event", example: "Purchase", prerequisites: ["optional Shared Profiles"], consumers: ["Flows", "Assignments", "Fixtures"] },
