...
function prototypeFromWorkbook(workbook, kind) {
    ...
    } return type === "image" && (source === "theme.logo" || source === "page.visual.image") ? [{ name, type: "image", source, range, ...(contractVersion === 3 ? { properties: parseExcelAreaProperties("image", rawProperties) } : {}) }] : []; });
