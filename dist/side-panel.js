...
function openContributorInUnifiedEditor(key) {
    ...
    if (selection.collectionKind === "pages" || selection.collectionKind === "pageGroups" || !selection.entity.canonicalSchema) {
