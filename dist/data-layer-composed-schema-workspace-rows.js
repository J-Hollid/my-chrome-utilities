...
export function renderComposedRows(rows, context) {
    ...
    for (const [index, { label }] of composedSchemaTableColumns.entries()) {
        ...
        if (index === 0) {
            ...
            applySchemaTablePropertyEditorAllocation(heading);
        }
