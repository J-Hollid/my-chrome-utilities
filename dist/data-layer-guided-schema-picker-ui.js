import { assignmentScopeSummary, searchSchemaDestinationOptions, } from "./data-layer-guided-validation.js";
...
export function renderGuidedSchemaPicker({ container, draft, candidates, query, onQuery, onClose, onSelect, }) {
    ...
    const searchLabel = element("label", "Schema search");
    searchLabel.htmlFor = "guided-schema-search";
    const search = element("input");
    search.id = "guided-schema-search";
    search.type = "search";
    search.value = query;
    search.setAttribute("aria-describedby", "guided-schema-search-hint");
    const searchHint = element("p", "Search schema names, versions, targets, properties, events, domains, and paths.");
    searchHint.id = "guided-schema-search-hint";
    ...
    if (!options.length) {
        ...
        clear.type = "button";
        clear.addEventListener("click", () => onQuery(""));
    ...
    dialog.append(heading, close, searchLabel, search, searchHint, count, results);
    container.append(dialog);
    dialog.showModal();
    search.focus({ preventScroll: true });
    search.setSelectionRange(search.value.length, search.value.length);
}
//# sourceMappingURL=data-layer-guided-schema-picker-ui.js.map