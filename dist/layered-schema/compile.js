...
const invariantFacet = (constraint, facet) => constraint.enforcement === "invariant" || Boolean(ruleKindForFacet(facet) && peerRule(constraint, ruleKindForFacet(facet))?.enforcement === "invariant");
