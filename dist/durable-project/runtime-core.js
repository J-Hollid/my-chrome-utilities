...
import { createVersion2ProjectLibraryTransport } from "./project-library-transport-v2.js";
export async function createDurableProjectRuntime(repository, legacy, startup = {}) {
    ...
    storage.projectLibraryTransport = createVersion2ProjectLibraryTransport({ repository, library: () => currentLibrary, id: oldId => `import:${crypto.randomUUID()}:${oldId.split(":")[0]}` });
