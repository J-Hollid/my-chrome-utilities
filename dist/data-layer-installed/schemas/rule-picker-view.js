...
export class SchemaRulePickerView {
    ...
    render() {
        ...
        const changeSeverity = () => { configuration.severity = severity.value; refresh(); }, changeMessage = () => { configuration.message = message.value; c.setConfiguration(configuration); }, changeEnabled = () => { configuration.enabled = enabled.checked; c.setConfiguration(configuration); };
        ...
        if (!c.editingAttached && configuration.saveReusable) {
            ...
            const changeName = () => { configuration.reusableName = name.value; refresh(); }, changeDescription = () => { configuration.description = description.value; c.setConfiguration(configuration); };
