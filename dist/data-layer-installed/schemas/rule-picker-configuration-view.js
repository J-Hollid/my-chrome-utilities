...
export function renderRulePickerConfiguration(c, p, path, rerender, normalize, renderRoot, workingConfiguration) {
    ...
    const configuration = workingConfiguration, editLabel = c.editingAttached
        ...
        : "Create local rule", form = document.createElement("form"), heading = document.createElement("h4"), context = document.createElement("p"), status = document.createElement("output");
...
//# sourceMappingURL=rule-picker-configuration-view.js.map