...
export class SchemaCanonicalPersistenceWorkflow {
    ...
    projection(canonical) { return this.#ports.view.projection(canonical); }
    ...
    beginSettlement(schemaId) {
        const settlement = this.#ports.canonical.beginSettlement(schemaId);
        this.#ports.editor?.setAttribute("aria-busy", "true");
        if (this.#ports.save)
            this.#ports.save.disabled = true;
        return settlement;
    }
