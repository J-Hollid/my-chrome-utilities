...
export function createSchemasInstalledController(ports) {
    ...
    const openSchemaRevisionReview = () => { renderSchemaDraft(); if (schemaRevisionReview)
        schemaRevisionReview.hidden = false; schemaRevisionReview?.showModal(); };
