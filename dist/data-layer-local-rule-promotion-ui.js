import { validateLocalRulePromotion, } from "./data-layer-local-rule-promotion.js";
...
export function createLocalRulePromotionDialog() {
    ...
    return {
        ...
        open(input) {
            ...
            const selectedAction = () => dialog.querySelector('input[name="local-rule-promotion-action"]:checked');
            const selection = () => {
...
//# sourceMappingURL=data-layer-local-rule-promotion-ui.js.map