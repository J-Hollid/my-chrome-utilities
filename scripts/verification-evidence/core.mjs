...
export function legacyArchivedCheckpointTaskIdentities(receipt, candidatePacks, packIds) {
  const candidates = [
    ...
    ...sortedUnique(packIds).filter((packId) =>
      candidatePacks.some(({ id }) => id === packId)).flatMap((packId) => planVerification(candidatePacks, {
...
export async function runVerificationEvidenceCommand(args) {
