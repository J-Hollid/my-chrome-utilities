# Feature development focus and RepoWise trial record R01

Status: historical trial evidence split from the active scoping convention on
2026-08-30

These trials explain why routine RepoWise scouting stopped. They do not change
the active rules in
`docs/feature-development-focus-and-advisory-scouting-R01.md`.
