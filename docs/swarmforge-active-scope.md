...
| QA-pilot verification latency correction | Slice 1 mode-aware incident correction approved on 2026-08-12 after its first focused run exposed a second all-pack route | `docs/qa-pilot-verification-latency-correction-R01.md` requires terminal-verification-deferred QA state and reserves incident resolution for master integration. |
