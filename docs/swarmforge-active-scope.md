...
| Verification run-intent and deferred-incident corrections | QA-integrated through live registry/planner order correction `cad10c898c`; exact-candidate eligible-repair admission policy and implementation handoff approved on 2026-08-19 | Implement the bounded automatic admission and safely resumable review/deferral transaction under `docs/qa-exact-candidate-eligible-repair-admission-R01.md`; no feature-mode all-20 run is authorized. |
