...
|---|---|---|
| QA-branch release pilot | Active; coder-timed RepoWise Trial 4 applies to the next ordinary QA feature after Flow contextual action consistency | `docs/qa-branch-release-pilot-R01.md` controls feature integration into `qa`; `docs/feature-development-focus-and-advisory-scouting-R01.md` controls the lightweight scoping convention and required Trial 4 feedback. |
