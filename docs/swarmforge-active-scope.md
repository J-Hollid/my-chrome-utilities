...
| Flow click and drag-ownership correction | Active by user approval on 2026-08-16 | Implement directional Flow scenarios 043–045 and their runtime partners under `docs/data-layer-canvas-first-flow-workspace-program-R02.md` as task `flow-pointer-click-ownership`; use the bounded Flow consumer pack set and do not run the all-20 gate. |
