...
|---|---|---|
| Serena development pilot | Optional-tool preparation independently reviewed and QA-integrated at `fa6c204e9d`; original pilot resumes | Resume `serena-development-pilot` under `docs/serena-development-pilot-R01.md` from the QA recording descendant. Use the reviewed optional-tool authority; preserve core runtime checks and global ownership. Read `docs/serena-preparation-qa-scorecard.md` for focused proof, process failures, and retained release obligations. No product patch needs reapplication. |
