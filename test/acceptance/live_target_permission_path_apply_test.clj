...
;; {:version 1, :tested-at "2026-08-26T09:58:17.814735547+02:00", :module-hash "1661441014", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 5, :hash "92638594"} {:id "def/feature-path", :kind "def", :line 7, :end-line 7, :hash "-57033470"} {:id "form/2/deftest", :kind "deftest", :line 9, :end-line 19, :hash "-1497622675"}]}
