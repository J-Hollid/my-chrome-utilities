...
export function bootstrapPlan(overrides={}) {
  return {
    ...
    sourceClosureDigest:"9".repeat(64),
    sourceTaskKeys:["build:dist","property:bootstrap-source",
      "acceptance-session:verification_process"],
    sourceOwnerPackIds:["verification_process"],
    sourcePrerequisiteTaskKeys:["build:dist"],
    sourceConsumerTaskKeys:["acceptance-session:verification_process"],
    sourcePropertyTaskKeys:["property:bootstrap-source"],
    sourcePackageTaskKeys:["package:extension"],
