...
function flowVisualRepairProtocol(runtime){const context=JSON.parse(process.env.SWARMFORGE_TIMEOUT_REPAIR_REGRESSION),expectedPreRepairFailure={fixedAggregateLimitRetained:true,storageAwareDiagnostic:false},expectedRepairResult={fixedAggregateLimitRetained:false,storageAwareDiagnostic:true},observed={fixedAggregateLimitRetained:runtime.runtime036?.aggregateLimitRemoved!==true,storageAwareDiagnostic:runtime.runtime036?.storageAwareDiagnostic===true},fixture={id:"flow-visual-durable-storage-diagnostic-v1",causalCategory:context.causalCategory,diagnosedBoundaryDigest:repairDigest(context.diagnosedBoundary),input:{replacedLimit:"25 MiB project aggregate",preflight:"navigator.storage.estimate"},expectedPreRepairFailure,expectedRepairResult},fixtureDigest=repairDigest(fixture);assert.deepEqual(observed,expectedRepairResult);return{version:2,incidentId:context.incidentId,failureDigest:context.failureDigest,fixture,preRepairResult:{status:"failed",fixtureDigest,observed:expectedPreRepairFailure},repairResult:{status:"passed",fixtureDigest,observed}};}
