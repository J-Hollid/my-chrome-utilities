...
const state=(id,name,site)=>{
  ...
  value.project.documentationFlowGraphs={[`flow:${id}`]:{pageFrames:[{id:`frame:${id}`,name:"Cart step",pageId:`page:${id}`}],occurrences:[{id:`occurrence:${id}`,name:"Purchase occurrence",pageFrameId:`frame:${id}`,pageId:`page:${id}`,eventId:`event:${id}`}],relationships:[]}};
