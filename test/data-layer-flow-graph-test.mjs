...
assert.equal("pageGroupIds" in laneState.project.collections.flows.at(-1),false);assert.deepEqual(documentaryFlowGraph(laneState.project,laneFlow.id).pageGroupIds,[checkoutGroup.id,deliveryGroup.id,confirmationGroup.id]);
