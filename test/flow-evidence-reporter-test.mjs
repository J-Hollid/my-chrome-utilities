...
assert.equal(FLOW_RUNTIME_KEYS.at(-1),"runtime047","the reporter must audit the latest schema-editor scrolling runtime independently");
...
falseNewest.runtime047={observed:false};
assert.deepEqual(flowEvidenceFailures(falseNewest),[
  {path:"runtime047.observed",value:false,expected:true},
]);
