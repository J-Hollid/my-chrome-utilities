...
assert.equal(FLOW_RUNTIME_KEYS.at(-1),"runtime048","the reporter must audit the latest derived array-example runtime independently");
...
falseNewest.runtime048={observed:false};
assert.deepEqual(flowEvidenceFailures(falseNewest),[
  {path:"runtime048.observed",value:false,expected:true},
]);
