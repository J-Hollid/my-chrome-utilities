...
(async()=>{
  ...
  return{
    runtime014:{reloadStable:graph.pageFrames.find(({id})=>id===${JSON.stringify(seeded.frameIds[0])}).nameInFlow==='Basket page'&&['Basket page','Payment source renamed','Review source renamed'].every((name)=>canvas.textContent.includes(name)&&outline.textContent.includes(name))},
