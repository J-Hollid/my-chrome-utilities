...
const schemaPropertyCommentsRuntime = `(async () => {
  ...
  try {
    ...
    const headings = Array.from(builder.querySelectorAll("th[data-specification-column] > span:not(.reorderable-editor-control)"), ({ textContent }) => textContent);
