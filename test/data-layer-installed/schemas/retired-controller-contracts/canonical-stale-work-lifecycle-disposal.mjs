...
export const group = {
  ...
  "checks": [
    ...
    },
    {
      ...
      "expected": "undefined",
      "binding": "assert.equal(editor.querySelector(\"#compact-canonical-table-editor\"),undefined, \"Schemas removes its on-demand canonical table host during disposal\");"
    },
    {
      ...
      "expected": "true",
      "binding": "assert.equal(staleContext.hidden,true,\"a settlement completing after disposal cannot reopen stale canonical UI\");"
    },
    {
      ...
      "binding": "assert.notEqual(staleHydrationResult.textContent,\"Loaded schema contributors for Stale Project.\", \"a durable hydration settling after disposal cannot render stale project state\");"
    },
    {
    ...
    },
    {
      ...
      "expected": "undefined",
      "binding": "assert.equal(persistenceListener,undefined,\"disposal detaches the durable persistence port\");"
    },
    {
      ...
      "expected": "1",
      "binding": "assert.equal(layeredProfileDisposals,1,\"Schemas disposes the layered Profile editor with its owner lifecycle\");"
    },
    {
      ...
      "expected": "0",
      "binding": "assert.equal(disposalGuidedChoice.listenerCount(),0,\"disposal removes the guided continuation choice listener\");"
    },
    {
      ...
      "expected": "0",
      "binding": "assert.equal(disposalExpansionConfirm.listenerCount(),0,\"disposal removes the open allowed-value dialog listeners\");"
    },
    {
      ...
      "expected": "[]",
      "binding": "assert.deepEqual(retainedSchemaListeners,[],\"Schemas removes every installed subscription it owns\");"
    }
  ]
};
