/** Source revision and close retired assertions. */
export const checks = [
  {
  ...
  },
  {
    ...
    "binding": "assert.equal(schemaStorageWrites,newWritesBeforeReview);"
  },
  {
  ...
  },
  {
    ...
    "binding": "assert.equal(schemaStorageWrites,newWritesBeforePublish+1);"
  },
  {
  ...
  },
  {
    ...
    "binding": "assert.equal(schemaStorageWrites,closeReviewWrites);"
  },
  {
    ...
    "binding": "assert.equal(relationshipActions.at(-1),\"schema:page:working-draft\");"
  },
  {
  ...
  },
  {
    ...
    "binding": "assert.equal(relationshipActions.at(-1),\"schema:page:historical:1\");"
  },
  {
  ...
  },
  {
    ...
    "binding": "assert.equal(schemaStorageWrites,storedDraftWrites);"
  },
  {
    ...
    "binding": "assert.equal(values.get(\"library\"),storedDraftStorage);"
  },
  {
  ...
  },
  {
    ...
    "binding": "assert.equal(schemaStorageWrites,abandonWrites);"
  },
  {
  ...
  },
  {
    ...
    "binding": "assert.equal(schemaStorageWrites,discardStoredWrites+1);"
  },
  {
