...
assert.equal(configured,true);assert.equal(typeof domain.persistence.render,"function");
...
domain.dispose();assert.deepEqual(disposed,["flow","close","view","guided","validation","canonical","persistence"]);
