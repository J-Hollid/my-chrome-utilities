...
const project={
  ...
  collections:{
    ...
    assignments:[
      {id:"assignment:retail",name:"Retail",targetId:"profile:retail",targetKind:"Shared Profile",applicabilitySetId:"app:retail",eventId:"event:purchase",priority:10},
      {id:"assignment:trade",name:"Trade",targetId:"profile:trade",targetKind:"Shared Profile",applicabilitySetId:"app:trade",eventId:"event:purchase",priority:10},
    ],
  },
};
