...
import { compatibleTimeoutRepairIncidentIds, focusedAcceptanceOptions, reliabilityAdmissionPartition, verificationArtifactIdentity } from "../../scripts/run-focused-acceptance.mjs";
import { timeoutIncidentDigest, timeoutRepairPackIds } from "../../scripts/verification-reliability-incidents.mjs";
...
assert.deepEqual(compatibleTimeoutRepairIncidentIds({requestedId:"incident-b",
  ...
  plannedTaskKeys:["unit:feature-contract","package:extension"],
  requiredFeatureTaskKeys:["unit:feature-contract"],propertiesIncluded:true,
...
for(const incomplete of [
  {plannedTaskKeys:["package:extension"],requiredFeatureTaskKeys:["unit:feature-contract"],
    propertiesIncluded:true,packageIncluded:true},
  {plannedTaskKeys:["unit:feature-contract","package:extension"],
    requiredFeatureTaskKeys:["unit:feature-contract"],propertiesIncluded:false,
    packageIncluded:true},
  {plannedTaskKeys:["unit:feature-contract"],requiredFeatureTaskKeys:["unit:feature-contract"],
    propertiesIncluded:true,packageIncluded:false},
]) {
