...
assert.deepEqual(compatibleTimeoutRepairIncidentIds({requestedId:"incident-b",
  ...
  focusedSelection:false,propertiesIncluded:true,
...
for(const incomplete of [
  {plannedTaskKeys:[],focusedSelection:false,propertiesIncluded:true,packageIncluded:true},
  {plannedTaskKeys:["unit:feature-contract","package:extension"],
    focusedSelection:false,propertiesIncluded:false,
    packageIncluded:true},
  {plannedTaskKeys:["unit:feature-contract"],focusedSelection:false,propertiesIncluded:true,
    packageIncluded:false},
  {plannedTaskKeys:["unit:feature-contract","package:extension"],focusedSelection:true,
