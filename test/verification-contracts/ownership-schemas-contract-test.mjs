...
const installedSchemaDirectOwners = [
  ...
  "test/data-layer-installed/schemas/retired-installed-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-source-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-property-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-rule-choice-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-rule-revision-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-assignment-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-library-import-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-library-deletion-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-library-export-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-guided-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-canonical-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-allowed-value-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-stale-work-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-project-durability-controller-contract-test.mjs",
  "test/data-layer-installed/schemas/retired-repair-regression-contract-test.mjs",
