...
import { checkpointPreflight, focusedAcceptanceOptions, verificationPromotionTasks } from "../../scripts/run-focused-acceptance.mjs";
import { createPendingVerificationEvidence, probeGitMetadataWrite, recordPendingVerificationEvidence, validateVerificationCandidateClean, validateVerificationEvidenceCompatibility, verificationEvidence, verificationDigest, verifyVerificationEvidence } from "../../scripts/verification-evidence.mjs";
