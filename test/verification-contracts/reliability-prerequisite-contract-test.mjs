...
import { applyCheckpointPrerequisitePlan, createCheckpointIdentityGuard, createVerificationCommandRunner, enforceTerminalClosureReceipt, focusedAcceptanceOptions, prepareCheckpointExecution, verificationPromotionTasks } from "../../scripts/run-focused-acceptance.mjs";
import { firstCanonicalDifference, preflightGitNotePromotion } from "../../scripts/verification-evidence.mjs";
...
import { createTimeoutIncidentStore, reliabilityFailureFingerprint, resolvedVerificationDeadlines, timeoutIncidentDigest, timeoutRepairCausalCategory } from "../../scripts/verification-reliability-incidents.mjs";
import { resolveIncidentTaskSuccession, taskSuccessionBoundaryDigest, validateUnresolvedIncidentTaskSuccession, verificationTaskDigest } from "../../scripts/verification-task-succession.mjs";
import { terminalProjectionCoverage, terminalProjectionCoverageValid } from "../../scripts/verification-reliability-deferred.mjs";
import { boundedClosureContractRevision, causalFailureIdentity, classifyReliabilityFailureDomain, closureDisposition, completeTaskInputClosure, inputEquivalentTaskProof, reliabilityFailureContract, terminalClosureExecution } from "../../scripts/verification-reliability-closure.mjs";
...
const transitivePrerequisiteTasks = [
  ...
  { key:"unit:receipt-source", stage:"unit", packId:"synthetic-prerequisite", executable:"node",
    args:["receipt-source.mjs"], requiredCapabilities:[], prerequisiteTaskKeys:[] },
  { key:"acceptance-parse:synthetic-prerequisite", stage:"acceptance-parse",
    packId:"synthetic-prerequisite", executable:"bb",
    args:["gherkin-parser"], requiredCapabilities:[], prerequisiteTaskKeys:["build:dist"] },
  { key:"acceptance-generate:synthetic-prerequisite", stage:"acceptance-generate",
    packId:"synthetic-prerequisite", executable:"bb",
    args:["acceptance-entrypoint-generator"], requiredCapabilities:[],
    prerequisiteTaskKeys:["acceptance-parse:synthetic-prerequisite"] },
  { key:"acceptance-session:synthetic-prerequisite", stage:"acceptance-session",
    packId:"synthetic-prerequisite", executable:"bb",
    args:["acceptance-pack-runner", "synthetic-prerequisite"], requiredCapabilities:[],
    prerequisiteTaskKeys:["unit:receipt-source", "acceptance-generate:synthetic-prerequisite"] },
];
...
["build:dist", "unit:receipt-source", "acceptance-parse:synthetic-prerequisite",
  "acceptance-generate:synthetic-prerequisite", "acceptance-session:synthetic-prerequisite"],
