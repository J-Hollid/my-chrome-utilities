...
import {prepareVtd014SharedBoundary} from "./vtd014-shared-incident-boundary.mjs";
export async function runReliabilityIncidentStore(context){
  ...
  try {
    ...
    const sharedBoundaryEvidence=await prepareVtd014SharedBoundary({
      store,registeredFailure:first,rawDiagnosticIneligible:rawRegisteredCommandsIneligible});
