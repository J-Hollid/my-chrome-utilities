...
import { assertReadOnlyArtifactLease } from "../support/verification-contract-boundary-helpers.mjs";
import { closeVerificationPlanPrerequisites, executeTimeoutRepairTaskPlan, focusedAcceptanceOptions, planPackageTask, selectFocusedVerificationTasks, validateRegistryCardinalityReviewPreflight } from "../../scripts/run-focused-acceptance.mjs";
import { closeCanonicalEvidencePlanPrerequisites, legacyAcceptanceSessionPrerequisiteCompatibility } from "../../scripts/verification-evidence.mjs";
...
import { loadVerificationPacks, validateVerificationPacks } from "../../scripts/verification-registry/validation.mjs";
...
import { registryPlannerPreparationFocusedPlan } from "../../scripts/verification-run-intent.mjs";
