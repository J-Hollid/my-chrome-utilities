...
const frameEdited=applyCanonicalCommand(frameProjection,{kind:"set",baseRevision:frameProjection.revision,propertyId:frameOwned.id,patch:{documentation:{...frameOwned.documentation,description:"Frame override"}}}),savedFrame=saveFlowPageInstanceCanonicalDocument(allScopes,"flow:ownership",frame.id,frameEdited.document),savedFrameRecord=savedFrame.project.documentationFlowGraphs["flow:ownership"].pageFrames[0];
