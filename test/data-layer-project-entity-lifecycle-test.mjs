...
const expectedCreationFields={profiles:["Profile purpose"],pageGroups:["Membership matcher"],pages:["Path matcher","Page Groups"],events:["Canonical event name"],applicabilitySets:["Priority","Fallback"],flows:["Correlation field"],fixtures:["Fixture mode","Event","Page","Flow","Release policy"],schemaDrafts:["Schema description"],assignments:["Schema","Event","Applicability Set","Priority","Version policy"]};
