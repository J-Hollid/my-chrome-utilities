...
const expectedCreationFields={profiles:["Profile purpose"],pageGroups:["Membership matcher"],pages:["Observed event name","Path matcher","Page Groups"],events:["Canonical event name"],applicabilitySets:["Priority","Fallback"],flows:["Correlation field"],fixtures:["Fixture mode","Event","Page","Flow","Release policy"],assignments:["Contributor kind","Contributor target","Event","Applicability Set","Priority"]};
