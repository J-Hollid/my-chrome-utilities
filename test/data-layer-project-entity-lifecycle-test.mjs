...
assert.equal(configuredPage.description,"Product detail context");assert.equal("eventName" in configuredPage,false);assert.equal("pathname" in configuredPage,false);assert.deepEqual(configuredPage.pageGroupIds,[],"Page Group membership is added from the searchable Page workspace picker");
