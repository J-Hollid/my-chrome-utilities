...
export type ConditionPredicate={kind:"predicate";propertyId:string;operator:string;value?:unknown};
export type ConditionGroup={kind:"all"|"any"|"not";children:ComposedCondition[]};
