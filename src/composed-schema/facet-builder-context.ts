...
import type {StableIdentitySequence} from "../reorderable-editor/stable-identities.js";
...
export interface BuilderRenderContext {options:BuilderOptions;draft:()=>ComposedFacetDraft;setDraft:(next:ComposedFacetDraft)=>void;feedback:()=>string;setFeedback:(value:string)=>void;render:()=>void;allowedValueIdentities:StableIdentitySequence;}
