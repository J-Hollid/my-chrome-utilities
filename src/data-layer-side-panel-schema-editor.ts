...
export type SidePanelSchemaGroupName="Saved schemas"|"Shared"|"Property Sets"|"Pages"|"Events"|"Flow instances"|"Occurrences";
...
export function resolveSidePanelSchemaContributor(state:ProjectState,key:string):SidePanelContributorSelection|undefined{
  const collections:[ProjectEntityKind,LayerScope][]=[["profiles","Shared Profile"],["propertySets","Property Set"],["pages","Page"],["events","Event"]];
