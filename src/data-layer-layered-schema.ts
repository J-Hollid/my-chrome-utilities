...
export interface EffectiveProperty extends LayerConstraint{origins:LayerOrigin[];superseded:{contributorId:string;contributorName:string;value:unknown}[];facetSources?:Partial<Record<"type"|"presence",LayerOrigin>>;expectedContributor?:string;expectedContributors?:string[];peerContributions?:LayerPeerContribution[];downstreamContributions?:LayerDownstreamContribution[]}
export interface LayerConflict{path:string;message:string;contributors:string[];contributorIds?:string[];facet?:"Type"|"Presence";sourceContributor?:string;sourceContributorId?:string;sourceValue?:unknown;localContributor?:string;localContributorId?:string;localValue?:unknown}
