...
export interface LayerConstraint{path:string;type?:string;itemType?:string;allowedValues?:readonly unknown[];allowedValueIds?:readonly string[];allowedValueProvenance?:readonly LayerValueProvenance[];presence?:LayerPresence;patterns?:readonly string[];minimum?:number;maximum?:number;minItems?:number;maxItems?:number;rules?:readonly Record<string,unknown>[];reusableRules?:readonly Record<string,unknown>[];expectedValue?:unknown;enforcement?:"invariant"|"overridable";target?:string;condition?:Record<string,unknown>;documentation?:string;examples?:readonly unknown[];definitionId?:string;overrideReferences?:readonly string[]}
