...
export interface EffectiveProperty extends LayerConstraint{origins:LayerOrigin[];superseded:{contributorId:string;contributorName:string;value:unknown}[];expectedContributor?:string;expectedContributors?:string[];peerContributions?:LayerPeerContribution[];downstreamContributions?:LayerDownstreamContribution[]}
export interface LayerConflict{path:string;message:string;contributors:string[];facet?:"Type"|"Presence";sourceContributor?:string;sourceValue?:unknown;localContributor?:string;localValue?:unknown}
