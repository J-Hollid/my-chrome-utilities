...
export interface EffectiveProperty extends LayerConstraint{origins:LayerOrigin[];superseded:{contributorId:string;contributorName:string;value:unknown}[];expectedContributor?:string;expectedContributors?:string[];peerContributions?:LayerPeerContribution[]}
