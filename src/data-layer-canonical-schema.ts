...
export interface CanonicalRule {id:string;kind:"pattern"|"range"|"cardinality"|"condition"|"reusable"|"custom";pattern?:string;minimum?:number;maximum?:number;minItems?:number;maxItems?:number;condition?:CanonicalPredicate;severity:"error"|"warning";message?:string;enabled?:boolean;reusableRuleId?:string;replacesRuleId?:string;enforcement?:"invariant"|"overridable";name?:string;revision?:number;operator?:string;provenance?:CanonicalProvenance;}
