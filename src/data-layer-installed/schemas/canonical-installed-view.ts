...
export class SchemaCanonicalInstalledView {
  ...
  openPropertyActions(path:string,trigger?:HTMLButtonElement):boolean {
    ...
    c.propertyMenuId=original.id; p.setSelectedPath(path.replace(/^\//,"").replaceAll("/",".")); if (!trigger) { this.renderContext(); return true; }
