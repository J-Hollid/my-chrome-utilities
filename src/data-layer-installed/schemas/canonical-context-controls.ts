...
export class SchemaCanonicalContextControls {
    ...
    renderContext(): void {
        ...
        if (c.pendingCommand) {
            ...
            const compareLatest = (): void => { c.showPendingComparison(); rerender(); }, retryAction = (): void => c.retryCommand(), rejectAction = (): void => c.rejectCommand();
    ...
    dispose(): void { this.clearContext(); this.#propertyMenuId = undefined; }
}
