...
export function createSchemasInstalledController(ports: SchemasInstalledPorts) {
  ...
  return {
    ...
    publish(): SchemaDefinition { const published = publishSchemaWorkingDraft(active()); replaceActive(published); persistSchemaLibrary(); renderSchemas(); return structuredClone(published); },
