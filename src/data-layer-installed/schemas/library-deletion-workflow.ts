...
export function inspectSchemaDeletion(schemas: readonly SchemaDefinition[], id: string): SchemaDeletionReview | undefined {
    ...
    if (children.length) {
        return {
            status: "blocked",
            message: `Cannot delete ${schema.name}: it is the parent of ` +
