...
import {activateFocusedOwnershipSection,focusedOwnershipActions,focusedOwnershipSectionEditable,focusedPropertyLifecycleOperation,type FocusedOwnershipSession,type FocusedPropertyPrimarySection,type FocusedPropertySection} from "../data-layer-focused-schema-property-ui.js";
...
export function mountCanonicalSchemaEditor(options:CanonicalSchemaEditorOptions):{render():void}{
  ...
  let ownershipSession:FocusedOwnershipSession={inherited:false,local:true,activated:[]};
