...
export interface LiveFlowHistoryEntry {
  ...
  relationshipId?:string;effectiveSchemaRevision:number;issues:LayerValidationIssue[];contributors:LayerContributor[];
