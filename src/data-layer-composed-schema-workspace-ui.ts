...
export function composedTableResetFacet(row:ComposedSchemaRow,facet:"type"|"presence"):Omit<LayerConstraint,"path"> {
...
export function mountComposedSchemaWorkspace(options:ComposedSchemaWorkspaceUiOptions):HTMLElement {
  ...
  const resetInline=(row:ComposedSchemaRow,facet:"type"|"presence"):SchemaTableQuickEditResult=>{
