...
export interface FlowWorkspaceView{camera:FlowCamera;cameraInitialized:boolean;surface:FlowWorkspaceSurface|undefined;minimap:boolean;focusCanvas:boolean;navigationVisible:boolean;visualDisplayMode:"Hidden"|"Badges"|"Thumbnails"}
...
export function initialFlowWorkspaceView():FlowWorkspaceView{return{camera:{x:0,y:0,zoom:1},cameraInitialized:false,surface:undefined,minimap:false,focusCanvas:false,navigationVisible:true,visualDisplayMode:"Badges"};}
