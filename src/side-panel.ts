...
import { mountLiveFlowTestingUi, type CompletedLiveFlowTest, type LiveFlowHistoryEntry, type LiveFlowTestRun } from "./utilities/data-layer/live-inspection.js";
import {
...
function manualFlowDefectEvent(entry:LiveFlowHistoryEntry,event:LiveEvent,run:LiveFlowTestRun|undefined):LiveEvent{
...
function startManualFlowDefectReport(entry:LiveFlowHistoryEntry,event:LiveEvent):void{
  if(!liveObserverElements.eventInspector)return;const selected=manualFlowDefectEvent(entry,event,liveFlowTestingUi.run());
