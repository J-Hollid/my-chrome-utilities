...
export const installProjectDocumentationWorkspaceContribution=(options:ProjectDocumentationWorkspaceContributionOptions):ProjectDocumentationWorkspaceContribution=>installProjectDocumentationWorkspaceUi(options);
