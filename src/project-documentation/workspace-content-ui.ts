...
export function renderDocumentationContent(host:HTMLElement,set:ProjectDocumentationSet,available:ProjectDocumentationSources,saveSet:SaveSet,focusScope:ParentNode=host):void {
  ...
  const choice=(label:string,check:HTMLInputElement):HTMLLabelElement=>labelled(label,check);
