Feature: Data layer project portability and upgrade
  ...
  Scenario: Data layer project portability and upgrade 001
    Given active Retail website is persisted at Draft revision 14 with metadata, schemas, Pages, Page Groups, Events, Flows, occurrences, applicability, assignments, documentation settings, and adopted-schema lineage
    When the operator exports Retail website from the Projects tab
    Then one versioned project bundle identifies project-retail and Draft revision 14
    ...
    And export changes neither the active project nor any project revision
  ...
  Scenario: Data layer project portability and upgrade 002
    ...
    Then import review shows format version, source name, source Draft revision, entity counts, reference integrity, migrations, unique target name Retail website copy, and Import as new project
  ...
  Scenario: Data layer project portability and upgrade 004
    Given the pre-library installation contains one singleton Legacy shop project with stable identity project-legacy, metadata, Draft revision 9, project graph, navigation, and Undo history
    ...
    And metadata, Draft revision 9, project graph, navigation, and Undo history remain available
  ...
  Scenario: Data layer project portability and upgrade 005
    ...
    And existing projects retain their metadata, canonical graphs, and Draft revisions
