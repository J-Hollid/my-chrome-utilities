...
Feature: Modular verification packs
  ...
  Scenario: Modular verification packs 073
    ...
    Then all 50 unit files, 29 property files, 105 feature files, 61 handlers, two browser adapters, and 46 registered browser targets remain in the 299-task conserved owner plan
