...
# MVP scope notice: production property-table behavior remains; selecting Flow semantics must use the complete graph dossier rather than merely suppressing a lossy warning.
