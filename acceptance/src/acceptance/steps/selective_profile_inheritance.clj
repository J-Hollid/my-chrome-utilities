...
(def runtime-paths (set (map #(keyword (str "runtime" (format "%03d" %))) (range 1 21))))
...
;; {:version 1, :tested-at "2026-07-31T18:10:54.696993711+02:00", :module-hash "1247204857", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 6, :hash "1219657973"} {:id "def/feature-files", :kind "def", :line 8, :end-line 9, :hash "2022211930"} {:id "def/entry-modes", :kind "def", :line 10, :end-line 11, :hash "1254300539"} {:id "form/3/defonce", :kind "defonce", :line 12, :end-line 12, :hash "344781070"} {:id "form/4/defonce", :kind "defonce", :line 13, :end-line 13, :hash "-1618529344"} {:id "defn-/checked!", :kind "defn-", :line 14, :end-line 14, :hash "-148274062"} {:id "defn-/verify-model!", :kind "defn-", :line 15, :end-line 15, :hash "784662512"} {:id "defn-/observe-browser!", :kind "defn-", :line 16, :end-line 16, :hash "691027597"} {:id "def/runtime-paths", :kind "def", :line 17, :end-line 17, :hash "-385295467"} {:id "def/authoritative-examples", :kind "def", :line 18, :end-line 18, :hash "-2126809929"} {:id "defn-/validate-example!", :kind "defn-", :line 19, :end-line 19, :hash "-154495481"} {:id "defn-/assert-runtime!", :kind "defn-", :line 20, :end-line 20, :hash "2049424878"} {:id "def/handlers", :kind "def", :line 21, :end-line 21, :hash "-1407196209"}]}
