...
;; {:version 1, :tested-at "2026-08-06T12:15:19.462645495+02:00", :module-hash "-2036043994", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 5, :hash "-485998160"} {:id "defn-/enough-verification-packs?", :kind "defn-", :line 7, :end-line 8, :hash "380845414"} {:id "def/browser-adapter-modes", :kind "def", :line 10, :end-line 11, :hash "-1768145777"} {:id "defn-/classified-browser-adapters", :kind "defn-", :line 13, :end-line 16, :hash "1447896627"} {:id "defn-/inspection-context", :kind "defn-", :line 18, :end-line 29, :hash "-958601117"} {:id "defn-/assert-pack-fields!", :kind "defn-", :line 31, :end-line 36, :hash "-687209790"} {:id "defn-/assert-adapter-classifications!", :kind "defn-", :line 38, :end-line 46, :hash "-950151277"} {:id "defn-/assert-registered-paths!", :kind "defn-", :line 48, :end-line 52, :hash "1363454567"} {:id "defn-/assert-shared-adapters!", :kind "defn-", :line 54, :end-line 58, :hash "-1460578147"} {:id "defn-/assert-source-signals!", :kind "defn-", :line 60, :end-line 96, :hash "-119336619"} {:id "defn-/assert-owning-pack-batches!", :kind "defn-", :line 98, :end-line 108, :hash "1703688010"} {:id "defn-/assert-browser-batching!", :kind "defn-", :line 110, :end-line 122, :hash "1599646018"} {:id "defn-/assert-runtime-boundaries!", :kind "defn-", :line 124, :end-line 132, :hash "767574382"} {:id "defn-/inspect-repository!", :kind "defn-", :line 134, :end-line 142, :hash "-552939158"} {:id "defn-/inspect!", :kind "defn-", :line 144, :end-line 151, :hash "661987012"} {:id "def/handlers", :kind "def", :line 153, :end-line 155, :hash "1432102857"}]}
