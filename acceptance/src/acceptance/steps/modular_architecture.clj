(ns acceptance.steps.modular-architecture
  (:require [acceptance.verification-support.modular-architecture-capture-handlers :as capture]
            ...
            [acceptance.verification-support.modular-architecture-vtd015-handlers :as vtd015]
            [acceptance.verification-support.modular-architecture-vtd017-handlers :as vtd017]
...
(def priority-handlers
  (vec (vtd014/priority-handlers {:example-values example-values})))
...
;; {:version 1, :tested-at "2026-08-31T14:57:10.254457356+02:00", :module-hash "-1606260419", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 24, :hash "1035500073"} {:id "defn-/enough-verification-packs?", :kind "defn-", :line 26, :end-line 27, :hash "1921574618"} {:id "form/2/defonce", :kind "defonce", :line 29, :end-line 29, :hash "572982016"} {:id "form/3/defonce", :kind "defonce", :line 30, :end-line 30, :hash "1589893756"} {:id "form/4/defonce", :kind "defonce", :line 31, :end-line 31, :hash "999491289"} {:id "form/5/defonce", :kind "defonce", :line 32, :end-line 32, :hash "1288649779"} {:id "form/6/defonce", :kind "defonce", :line 33, :end-line 33, :hash "-1337826853"} {:id "form/7/declare", :kind "declare", :line 34, :end-line 34, :hash "470981416"} {:id "defn-/verify-throughput!", :kind "defn-", :line 36, :end-line 84, :hash "-1431330011"} {:id "defn-/parse-seconds", :kind "defn-", :line 86, :end-line 88, :hash "-309137656"} {:id "defn-/bounded-worker-load", :kind "defn-", :line 90, :end-line 96, :hash "-2029624008"} {:id "defn-/parse-task-durations", :kind "defn-", :line 98, :end-line 107, :hash "1259277085"} {:id "defn-/bounded-stage-world", :kind "defn-", :line 109, :end-line 116, :hash "-1428085136"} {:id "defn-/timing-evidence", :kind "defn-", :line 118, :end-line 149, :hash "528684167"} {:id "defn-/timing-world", :kind "defn-", :line 151, :end-line 155, :hash "1314606518"} {:id "def/report-row-estimates", :kind "def", :line 157, :end-line 159, :hash "-1582722125"} {:id "defn-/budget-world", :kind "defn-", :line 161, :end-line 171, :hash "78919961"} {:id "defn-/assert-seconds!", :kind "defn-", :line 173, :end-line 178, :hash "726379898"} {:id "defn-/assert-value!", :kind "defn-", :line 180, :end-line 184, :hash "356760800"} {:id "defn-/example-values", :kind "defn-", :line 186, :end-line 188, :hash "613161209"} {:id "defn-/canonical-ledger-world", :kind "defn-", :line 190, :end-line 195, :hash "-968309789"} {:id "defn-/environment-class-world", :kind "defn-", :line 197, :end-line 205, :hash "-466670476"} {:id "def/rejection-reasons", :kind "def", :line 207, :end-line 211, :hash "621663720"} {:id "defn-/receipt-eligibility-world", :kind "defn-", :line 213, :end-line 221, :hash "-813563194"} {:id "defn-/timing-sample-world", :kind "defn-", :line 223, :end-line 227, :hash "877595569"} {:id "defn-/minimum-sample-world", :kind "defn-", :line 229, :end-line 234, :hash "145658693"} {:id "defn-/evaluate-maturity", :kind "defn-", :line 236, :end-line 242, :hash "1652383274"} {:id "defn-/indexed-load-world", :kind "defn-", :line 244, :end-line 254, :hash "-515305694"} {:id "def/maintenance-results", :kind "def", :line 256, :end-line 264, :hash "-1157939848"} {:id "defn-/maintenance-world", :kind "defn-", :line 266, :end-line 269, :hash "1219897170"} {:id "defn-/run-maintenance", :kind "defn-", :line 271, :end-line 275, :hash "-1616042970"} {:id "defn-/assert-vtd002!", :kind "defn-", :line 277, :end-line 279, :hash "-1181928910"} {:id "def/flow-phase-names", :kind "def", :line 281, :end-line 283, :hash "-349843343"} {:id "defn-/flow-characterization", :kind "defn-", :line 285, :end-line 286, :hash "172318254"} {:id "defn-/valid-flow-distributions?", :kind "defn-", :line 288, :end-line 289, :hash "-1282739427"} {:id "defn-/flow-sample-world", :kind "defn-", :line 291, :end-line 292, :hash "-1124489281"} {:id "defn-/flow-maturity-world", :kind "defn-", :line 294, :end-line 296, :hash "-1849915962"} {:id "defn-/flow-budget-world", :kind "defn-", :line 298, :end-line 300, :hash "-422032915"} {:id "defn-/flow-completion-world", :kind "defn-", :line 302, :end-line 303, :hash "77649805"} {:id "defn-/assert-vtd013!", :kind "defn-", :line 305, :end-line 306, :hash "1768839120"} {:id "defn-/performance-calibration", :kind "defn-", :line 308, :end-line 309, :hash "1132048469"} {:id "defn-/calibration-pack", :kind "defn-", :line 311, :end-line 312, :hash "-1488891100"} {:id "defn-/calibration-target", :kind "defn-", :line 314, :end-line 315, :hash "2080664755"} {:id "defn-/calibration-pack-world", :kind "defn-", :line 317, :end-line 318, :hash "1915810833"} {:id "defn-/calibration-target-world", :kind "defn-", :line 320, :end-line 321, :hash "-1417319878"} {:id "defn-/calibration-world", :kind "defn-", :line 323, :end-line 324, :hash "2067073079"} {:id "defn-/regression-world", :kind "defn-", :line 326, :end-line 327, :hash "-2060316272"} {:id "defn-/assert-vtd003!", :kind "defn-", :line 329, :end-line 330, :hash "10390074"} {:id "defn-/inspect!", :kind "defn-", :line 332, :end-line 333, :hash "758818271"} {:id "def/core-handlers", :kind "def", :line 335, :end-line 813, :hash "-506619815"} {:id "def/priority-handlers", :kind "def", :line 815, :end-line 816, :hash "-574352698"} {:id "def/handlers", :kind "def", :line 818, :end-line 858, :hash "1291352753"}]}
