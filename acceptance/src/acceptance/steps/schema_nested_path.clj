...
(defn- assert-advanced-targets! [observed]
  (support/assert! (= [true
                       ["Add rule" "Add specific index rule" "Copy to another schema" "Remove property"]
