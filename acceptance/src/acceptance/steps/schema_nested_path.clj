...
(defn- assert-advanced-targets! [observed]
  (support/assert! (= [true
                       ["Edit type · Array of Object" "Add item property" "Add rule" "Add specific index rule" "Copy to another schema" "Remove property"]
