...
(defn validate-example! [_mode example]
  (support/validate-authoritative-example!
   ...
   example
   "Project-management example is not an authoritative contract row.")
...
;; {:version 1, :tested-at "2026-08-16T06:20:04.276983614+02:00", :module-hash "1698495330", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line nil, :hash "-408196865"} {:id "def/feature-files", :kind "def", :line 7, :end-line nil, :hash "-1613232606"} {:id "def/model-entries", :kind "def", :line 13, :end-line nil, :hash "-776214092"} {:id "def/runtime-entries", :kind "def", :line 51, :end-line nil, :hash "1320516684"} {:id "def/entry-modes", :kind "def", :line 89, :end-line nil, :hash "270029399"} {:id "form/5/defonce", :kind "defonce", :line 91, :end-line nil, :hash "344781070"} {:id "form/6/defonce", :kind "defonce", :line 92, :end-line nil, :hash "-1618529344"} {:id "defn-/checked!", :kind "defn-", :line 93, :end-line nil, :hash "1504155082"} {:id "defn-/verify-model!", :kind "defn-", :line 97, :end-line nil, :hash "745772617"} {:id "defn-/observe-browser!", :kind "defn-", :line 105, :end-line nil, :hash "497937204"} {:id "def/runtime-paths", :kind "def", :line 114, :end-line nil, :hash "899075426"} {:id "defn/complete-browser-evidence?", :kind "defn", :line 118, :end-line nil, :hash "-1866555812"} {:id "defn-/assert-runtime!", :kind "defn-", :line 122, :end-line nil, :hash "1764318754"} {:id "def/example-values", :kind "def", :line 126, :end-line nil, :hash "1687542411"} {:id "def/assignment-routing-examples", :kind "def", :line 168, :end-line nil, :hash "877625919"} {:id "def/authoritative-examples", :kind "def", :line 174, :end-line nil, :hash "1598887325"} {:id "defn/validate-example!", :kind "defn", :line 176, :end-line nil, :hash "111205315"} {:id "def/handlers", :kind "def", :line 188, :end-line nil, :hash "-1692449013"}]}
