...
(defn- assert-picker! [example observed]
  ...
  (support/assert! (and (str/includes? (:builtInConfiguration observed) "Create local rule for /page_type")
                        (str/includes? (:builtInConfiguration observed) "regular expression operator · type string"))
...
;; {:version 1, :tested-at "2026-08-27T17:52:06.272128753+02:00", :module-hash "-491650762", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "110500236"} {:id "def/feature-file", :kind "def", :line 5, :end-line 5, :hash "-1761985661"} {:id "form/2/defonce", :kind "defonce", :line 6, :end-line 6, :hash "-1819867165"} {:id "def/entry-step", :kind "def", :line 7, :end-line 7, :hash "-684177608"} {:id "defn-/load-observation!", :kind "defn-", :line 9, :end-line 15, :hash "1271028503"} {:id "defn-/observation!", :kind "defn-", :line 17, :end-line 17, :hash "-775394783"} {:id "def/availability-examples", :kind "def", :line 19, :end-line 28, :hash "1125325596"} {:id "def/search-examples", :kind "def", :line 30, :end-line 36, :hash "-481968028"} {:id "def/configuration-control-examples", :kind "def", :line 38, :end-line 46, :hash "-1864727962"} {:id "def/keyboard-examples", :kind "def", :line 48, :end-line 52, :hash "-1451509122"} {:id "defn-/property-rule-example", :kind "defn-", :line 54, :end-line 57, :hash "1631401399"} {:id "defn-/assert-property-rule-example!", :kind "defn-", :line 59, :end-line 65, :hash "587076922"} {:id "defn-/assert-availability-example!", :kind "defn-", :line 67, :end-line 70, :hash "-1133205309"} {:id "defn-/assert-search-example!", :kind "defn-", :line 72, :end-line 78, :hash "-1774368180"} {:id "defn-/assert-configuration-control-example!", :kind "defn-", :line 80, :end-line 83, :hash "-294410283"} {:id "defn-/assert-validation-example!", :kind "defn-", :line 85, :end-line 92, :hash "-549968143"} {:id "defn-/assert-keyboard-example!", :kind "defn-", :line 94, :end-line 99, :hash "2098227017"} {:id "defn-/assert-navigation-example!", :kind "defn-", :line 101, :end-line 110, :hash "1051386276"} {:id "defn-/assert-example!", :kind "defn-", :line 112, :end-line 118, :hash "-217916821"} {:id "defn-/assert-picker!", :kind "defn-", :line 120, :end-line 166, :hash "-1479057219"} {:id "defn-/transition", :kind "defn-", :line 168, :end-line 173, :hash "1019694489"} {:id "def/handlers", :kind "def", :line 175, :end-line 180, :hash "-1688861492"}]}
