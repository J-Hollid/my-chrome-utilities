...
(def runtime-paths (set (concat [:installedBoundary :consequential :persistenceReload :sidePanelParity]
                                (map #(keyword (str "authoring" (format "%03d" %))) (range 1 70))
...
;; {:version 1, :tested-at "2026-07-30T01:44:47.821718462+02:00", :module-hash "1543029358", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 6, :hash "-698030535"} {:id "def/feature-files", :kind "def", :line 8, :end-line 11, :hash "-948483249"} {:id "def/entry-modes", :kind "def", :line 12, :end-line 15, :hash "1996951125"} {:id "form/3/defonce", :kind "defonce", :line 16, :end-line 16, :hash "344781070"} {:id "form/4/defonce", :kind "defonce", :line 17, :end-line 17, :hash "-1618529344"} {:id "defn-/checked!", :kind "defn-", :line 18, :end-line 18, :hash "-148274062"} {:id "defn-/verify-model!", :kind "defn-", :line 19, :end-line 19, :hash "478763930"} {:id "defn-/observe-browser!", :kind "defn-", :line 20, :end-line 20, :hash "1525089788"} {:id "def/runtime-paths", :kind "def", :line 21, :end-line 27, :hash "39292955"} {:id "def/authoritative-examples", :kind "def", :line 28, :end-line 32, :hash "-2126809929"} {:id "defn-/validate-example!", :kind "defn-", :line 33, :end-line 38, :hash "-154495481"} {:id "defn-/assert-runtime!", :kind "defn-", :line 39, :end-line 39, :hash "-1316725059"} {:id "def/handlers", :kind "def", :line 40, :end-line 40, :hash "-211988156"}]}
