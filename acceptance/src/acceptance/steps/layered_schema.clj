...
;; {:version 1, :tested-at "2026-07-30T22:04:09.888052553+02:00", :module-hash "-89589597", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 6, :hash "-698030535"} {:id "def/feature-files", :kind "def", :line 8, :end-line 12, :hash "812142412"} {:id "def/entry-modes", :kind "def", :line 13, :end-line 17, :hash "1410402332"} {:id "form/3/defonce", :kind "defonce", :line 18, :end-line 18, :hash "344781070"} {:id "form/4/defonce", :kind "defonce", :line 19, :end-line 19, :hash "-1618529344"} {:id "defn-/checked!", :kind "defn-", :line 20, :end-line 20, :hash "-148274062"} {:id "defn-/verify-model!", :kind "defn-", :line 21, :end-line 21, :hash "-900871097"} {:id "defn-/observe-browser!", :kind "defn-", :line 22, :end-line 22, :hash "1525089788"} {:id "def/runtime-paths", :kind "def", :line 23, :end-line 31, :hash "1696497849"} {:id "def/authoritative-examples", :kind "def", :line 32, :end-line 36, :hash "-2126809929"} {:id "defn-/validate-example!", :kind "defn-", :line 37, :end-line 42, :hash "-154495481"} {:id "defn-/assert-runtime!", :kind "defn-", :line 43, :end-line 43, :hash "-1316725059"} {:id "def/handlers", :kind "def", :line 44, :end-line 44, :hash "-211988156"}]}
