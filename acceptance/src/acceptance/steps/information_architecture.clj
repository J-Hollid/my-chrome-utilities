...
;; {:version 1, :tested-at "2026-08-27T17:52:00.10066595+02:00", :module-hash "-1030162672", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "1853401062"} {:id "defn-/inspect", :kind "defn-", :line 5, :end-line 13, :hash "-615551382"} {:id "defn-/example-value", :kind "defn-", :line 15, :end-line 16, :hash "-1416813660"} {:id "def/navigation-structure?", :kind "def", :line 18, :end-line 18, :hash "-1038435563"} {:id "defn/contextual-actions?", :kind "defn", :line 20, :end-line 32, :hash "478297384"} {:id "form/5/defonce", :kind "defonce", :line 34, :end-line 34, :hash "-863505630"} {:id "defn-/observe-live-session-runtime!", :kind "defn-", :line 36, :end-line 42, :hash "-1094086938"} {:id "defn/runtime-live-session-controls", :kind "defn", :line 44, :end-line 49, :hash "-1197199286"} {:id "def/data-layer-secondary-views", :kind "def", :line 51, :end-line 51, :hash "-1480012677"} {:id "defn/data-layer-view-separation?", :kind "defn", :line 53, :end-line 58, :hash "-813930568"} {:id "defn/distinct-hidden-data-layer-views?", :kind "defn", :line 60, :end-line 65, :hash "-672641782"} {:id "defn/hidden-panel-css-wins?", :kind "defn", :line 67, :end-line 68, :hash "-1823432900"} {:id "defn-/require-layout", :kind "defn-", :line 70, :end-line 74, :hash "-319387143"} {:id "def/expected-hidden-schema-presentation", :kind "def", :line 76, :end-line 77, :hash "286998898"} {:id "defn/schema-view-contained?", :kind "defn", :line 79, :end-line 93, :hash "1719396821"} {:id "form/15/defonce", :kind "defonce", :line 95, :end-line 95, :hash "-661740018"} {:id "defn-/load-schema-view-containment!", :kind "defn-", :line 97, :end-line 108, :hash "1323435645"} {:id "defn-/observe-schema-view-containment", :kind "defn-", :line 110, :end-line 111, :hash "-1013975075"} {:id "defn-/require-schema-view-containment!", :kind "defn-", :line 113, :end-line 118, :hash "1803852679"} {:id "def/handlers", :kind "def", :line 120, :end-line 550, :hash "-1122843299"}]}
