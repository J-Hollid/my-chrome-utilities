...
;; {:version 1, :tested-at "2026-07-14T14:38:22.114500101+02:00", :module-hash "-1827724215", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-2138934778"} {:id "def/feature-files", :kind "def", :line 5, :end-line 5, :hash "475595923"} {:id "def/entry-steps", :kind "def", :line 6, :end-line 14, :hash "-1637132162"} {:id "form/3/defonce", :kind "defonce", :line 15, :end-line 15, :hash "-1819867165"} {:id "defn-/observation!", :kind "defn-", :line 17, :end-line 23, :hash "661837415"} {:id "defn-/assert-actions!", :kind "defn-", :line 25, :end-line 34, :hash "159843367"} {:id "defn-/assert-immediate-and-undo!", :kind "defn-", :line 36, :end-line 48, :hash "-444773895"} {:id "defn-/assert-confirmed-and-empty!", :kind "defn-", :line 50, :end-line 71, :hash "-99091577"} {:id "def/ancestor-examples", :kind "def", :line 73, :end-line 81, :hash "-313111910"} {:id "def/focus-examples", :kind "def", :line 83, :end-line 89, :hash "1232594176"} {:id "defn-/assert-outline-example!", :kind "defn-", :line 91, :end-line 108, :hash "860942701"} {:id "defn-/assert-observation!", :kind "defn-", :line 110, :end-line 116, :hash "2017158343"} {:id "defn-/transition", :kind "defn-", :line 118, :end-line 122, :hash "1411388438"} {:id "def/handlers", :kind "def", :line 124, :end-line 129, :hash "784379959"}]}
