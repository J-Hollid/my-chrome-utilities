...
;; {:version 1, :tested-at "2026-07-16T19:13:00.339428622+02:00", :module-hash "339698251", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-2138934778"} {:id "def/feature-files", :kind "def", :line 5, :end-line 5, :hash "475595923"} {:id "def/entry-steps", :kind "def", :line 6, :end-line 14, :hash "-1637132162"} {:id "form/3/defonce", :kind "defonce", :line 15, :end-line 15, :hash "-1819867165"} {:id "defn-/observation!", :kind "defn-", :line 17, :end-line 23, :hash "661837415"} {:id "defn-/assert-actions!", :kind "defn-", :line 25, :end-line 36, :hash "212528391"} {:id "defn-/assert-immediate-and-undo!", :kind "defn-", :line 38, :end-line 50, :hash "-444773895"} {:id "defn-/assert-confirmed-and-empty!", :kind "defn-", :line 52, :end-line 73, :hash "-99091577"} {:id "def/ancestor-examples", :kind "def", :line 75, :end-line 83, :hash "-313111910"} {:id "def/focus-examples", :kind "def", :line 85, :end-line 91, :hash "1232594176"} {:id "defn-/assert-outline-example!", :kind "defn-", :line 93, :end-line 110, :hash "860942701"} {:id "defn-/assert-observation!", :kind "defn-", :line 112, :end-line 118, :hash "2017158343"} {:id "defn-/transition", :kind "defn-", :line 120, :end-line 124, :hash "1411388438"} {:id "def/handlers", :kind "def", :line 126, :end-line 131, :hash "784379959"}]}
