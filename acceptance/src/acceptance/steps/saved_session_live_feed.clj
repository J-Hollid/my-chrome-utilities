...
(defn- assert-initial-actions! [initial]
  (support/assert! (= ["Open in Live feed" "Rename" "Export" "Start linked capture" "Create sequence" "Delete"]
                      (:actions initial))
