...
(def ^:private action-order ["" "+" "Adjust" "Remove"])
...
(defn assert-reproduction-composer! [example observation]
  (let [composer (get-in observation [:ui :reproductionComposer])
    ...
    (support/assert! (= ["" "Move to first" "Move one position earlier" "Move one position later" "Move to last" "Move…" "Adjust" "Remove"] (:manualActions composer)) "Manual-step actions are incomplete." composer)
    (support/assert! (= ["+" "Adjust" "Remove"] (:manualActionRow composer)) "Manual-step actions are not grouped in display order." composer)
    (support/assert! (= ["reorderable-editor-control" "defect-reproduction-step-text" "defect-reproduction-step-actions"] (:manualRowStructure composer)) "Manual-step rows do not begin with the grip, text, and action group." composer)
...
;; {:version 1, :tested-at "2026-08-20T22:15:46.066748745+02:00", :module-hash "-1223022929", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-1823940385"} {:id "defn-/assert-outline-example!", :kind "defn-", :line 5, :end-line 15, :hash "-1435903736"} {:id "def/action-order", :kind "def", :line 17, :end-line 17, :hash "-678214814"} {:id "def/checkout-boundary", :kind "def", :line 18, :end-line 23, :hash "544271857"} {:id "defn-/complete-layout?", :kind "defn-", :line 25, :end-line 28, :hash "-344994125"} {:id "defn-/contextual-row?", :kind "defn-", :line 30, :end-line 34, :hash "-514341073"} {:id "defn-/assert-action-row!", :kind "defn-", :line 36, :end-line 42, :hash "-1382539491"} {:id "def/builder-widths", :kind "def", :line 44, :end-line 48, :hash "1339250427"} {:id "defn-/assert-action-rows!", :kind "defn-", :line 50, :end-line 59, :hash "260462334"} {:id "defn/assert-reproduction-composer!", :kind "defn", :line 61, :end-line 119, :hash "-1546467867"}]}
