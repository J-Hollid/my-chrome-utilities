...
;; {:version 1, :tested-at "2026-08-22T06:47:37.260879636+02:00", :module-hash "-598421535", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-1823940385"} {:id "defn-/assert-outline-example!", :kind "defn-", :line 5, :end-line 15, :hash "-1435903736"} {:id "def/action-order", :kind "def", :line 17, :end-line 17, :hash "-745514784"} {:id "def/checkout-boundary", :kind "def", :line 18, :end-line 22, :hash "784984375"} {:id "defn-/complete-layout?", :kind "defn-", :line 24, :end-line 27, :hash "-344994125"} {:id "defn-/contextual-row?", :kind "defn-", :line 29, :end-line 33, :hash "-514341073"} {:id "defn-/assert-action-row!", :kind "defn-", :line 35, :end-line 41, :hash "-1382539491"} {:id "def/builder-widths", :kind "def", :line 43, :end-line 47, :hash "1339250427"} {:id "defn-/assert-action-rows!", :kind "defn-", :line 49, :end-line 58, :hash "260462334"} {:id "defn/assert-reproduction-composer!", :kind "defn", :line 60, :end-line 118, :hash "-1143490777"}]}
