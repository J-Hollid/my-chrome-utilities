  ...
  (let [live-observer-source (get files "src/data-layer-installed/capture/observation-sources/feed-ui.ts" "")]
    (and (str/includes? live-observer-source "const events=filteredLiveEvents(state)")
         ...
         (not (str/includes? live-observer-source
                             "const rows = document.createElement(\"details\")")))))
...
(def handlers
  [{:pattern #"^project <([A-Za-z0-9_]+)> has a current session containing captured events across multiple pathname visits$"
    :handler (fn [world example [project-name-key]]
               (let [project-name (support/require-example example project-name-key)]
                 (support/assert! (= "my-chrome-utilities" project-name)
                                  "The single-feed browser observation belongs to another project."
                                  {:project-name project-name})
                 (assoc world
                        :single-live-event-feed-observation
                        (load-single-live-event-feed-observation!))))}

   {:pattern #"^the current session page and event journey is presented once through the Live event feed$"
    :handler (fn [world _example _captures]
               (let [observation (:single-live-event-feed-observation world)]
                 (support/assert! (= {:visits ["/checkout" "/products"] :eventCount 3}
                                     (:journey observation))
                                  "The Live event feed does not present the current session journey once."
                                  observation)
                 (support/assert! (and (= 1 (:liveFeedCount observation))
                                       (:liveFeedInsideLivePanel observation))
                                  "The current-session journey is not owned by the Live feed."
                                  observation)
                 world))}

   {:pattern #"^a duplicate session timeline is absent below or beside the Data Layer views$"
    :handler (fn [world _example _captures]
               (let [observation (:single-live-event-feed-observation world)]
                 (support/assert! (zero? (:duplicateTimelineCount observation))
                                  "A duplicate current-session timeline is rendered."
                                  observation)
                 world))}

   {:pattern #"^Library, Sessions, and Schemas do not display another current-session event list$"
    :handler (fn [world _example _captures]
               (let [observation (:single-live-event-feed-observation world)]
                 (support/assert! (= [0 0 0] (:secondaryCurrentSessionLists observation))
                                  "A secondary Data Layer view renders the current-session event list."
                                  observation)
                 world))}

   {:pattern #"^the canonical captured chronology remains available for saved sessions and defect report reproduction$"
    :handler (fn [world _example _captures]
               (let [observation (:single-live-event-feed-observation world)
                     chronology ["pageview" "promotion" "purchase"]]
                 (support/assert! (= chronology (:archiveEventIds observation))
                                  "Saved sessions lost the canonical captured chronology."
                                  observation)
                 (support/assert! (= chronology (:defectEventIds observation))
                                  "Defect report reproduction lost the canonical captured chronology."
                                  observation)
                 world))}
   ...
   {:pattern #"^the feed contains <([A-Za-z0-9_]+)> loaded records$"
    :handler (fn [world example [count-key]]
               (let [count (Long/parseLong (support/require-example example count-key))]
                 (support/assert! (= 24 count)
                                  "Accessible feed fixture is not canonical."
                                  {:event-count count})
                 (assoc world :events (mapv #(hash-map :id (str "event-" %) :name "event") (range 1 (inc count))) :focused-event-id "event-12")))}
   ])

;; clj-mutate-manifest-begin
;; {:version 1, :tested-at "2026-09-08T18:17:38.183940811+02:00", :module-hash "122826438", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 5, :hash "-949602529"} {:id "def/timeline-timestamp", :kind "def", :line 7, :end-line 7, :hash "415657292"} {:id "def/canonical-first-page-url", :kind "def", :line 8, :end-line 8, :hash "892300575"} {:id "def/canonical-second-page-url", :kind "def", :line 9, :end-line 9, :hash "-854550659"} {:id "def/canonical-history-path", :kind "def", :line 10, :end-line 10, :hash "-1465520940"} {:id "def/canonical-event-groups", :kind "def", :line 11, :end-line 12, :hash "-1186297732"} {:id "def/canonical-payload-properties", :kind "def", :line 13, :end-line 18, :hash "-1279650964"} {:id "def/canonical-tuple-event-name", :kind "def", :line 19, :end-line 19, :hash "1033985506"} {:id "def/canonical-tuple-history-path", :kind "def", :line 20, :end-line 20, :hash "330325512"} {:id "def/canonical-tuple-timestamp", :kind "def", :line 21, :end-line 21, :hash "-1600040237"} {:id "def/canonical-expanded-page-url", :kind "def", :line 22, :end-line 22, :hash "-1460760503"} {:id "def/canonical-expanded-event-name", :kind "def", :line 23, :end-line 23, :hash "-935563380"} {:id "def/canonical-tuple-payload-values", :kind "def", :line 24, :end-line 27, :hash "1497266995"} {:id "form/13/defonce", :kind "defonce", :line 29, :end-line 29, :hash "-1869957696"} {:id "defn-/load-single-live-event-feed-observation!", :kind "defn-", :line 31, :end-line 37, :hash "-1852664165"} {:id "defn-/observed-entry", :kind "defn-", :line 39, :end-line 46, :hash "1690037188"} {:id "defn/record-observed-entry", :kind "defn", :line 48, :end-line 53, :hash "-1688208651"} {:id "defn/visible-timeline-entries", :kind "defn", :line 55, :end-line 58, :hash "1275635072"} {:id "defn/timeline-summary", :kind "defn", :line 60, :end-line 61, :hash "-712284424"} {:id "defn/expanded-entry", :kind "defn", :line 63, :end-line 64, :hash "602566461"} {:id "defn-/page-entry", :kind "defn-", :line 66, :end-line 67, :hash "975036707"} {:id "defn-/comma-list", :kind "defn-", :line 69, :end-line 70, :hash "-1163143512"} {:id "defn/parse-payload-properties", :kind "defn", :line 72, :end-line 77, :hash "519534170"} {:id "defn-/observed-event-entry", :kind "defn-", :line 79, :end-line 86, :hash "-1241889608"} {:id "defn-/append-timeline-entry", :kind "defn-", :line 88, :end-line 92, :hash "-1434428876"} {:id "defn-/record-events-for-page", :kind "defn-", :line 94, :end-line 100, :hash "-2026777991"} {:id "defn/record-pageloads-with-events", :kind "defn", :line 102, :end-line 106, :hash "-1198529879"} {:id "defn/record-observed-event-with-payload", :kind "defn", :line 108, :end-line 112, :hash "1577056021"} {:id "defn-/tuple-payload-object", :kind "defn-", :line 114, :end-line 121, :hash "298147558"} {:id "defn/record-observed-tuple", :kind "defn", :line 123, :end-line 134, :hash "-1059715210"} {:id "defn-/timeline-entries", :kind "defn-", :line 136, :end-line 139, :hash "-1795253343"} {:id "defn-/add-page-to-timeline", :kind "defn-", :line 141, :end-line 142, :hash "-2141246556"} {:id "defn-/latest-page-index", :kind "defn-", :line 144, :end-line 149, :hash "714616854"} {:id "defn-/add-event-to-matching-page", :kind "defn-", :line 151, :end-line 159, :hash "832033178"} {:id "defn-/add-entry-to-nested-timeline", :kind "defn-", :line 161, :end-line 165, :hash "1389420386"} {:id "defn/nested-timeline", :kind "defn", :line 167, :end-line 168, :hash "184350641"} {:id "defn/payload-property-items", :kind "defn", :line 170, :end-line 177, :hash "-1695777806"} {:id "defn/nested-event-details", :kind "defn", :line 179, :end-line 183, :hash "-1552917715"} {:id "defn/nested-timeline-pageload-order-matches?", :kind "defn", :line 185, :end-line 187, :hash "1626274005"} {:id "defn/nested-timeline-event-groups-match?", :kind "defn", :line 189, :end-line 191, :hash "-142142438"} {:id "defn/nested-timeline-observer-paths-match?", :kind "defn", :line 193, :end-line 195, :hash "434004617"} {:id "defn/canonical-payload-properties-match?", :kind "defn", :line 197, :end-line 199, :hash "420326762"} {:id "defn/render-observed-event", :kind "defn", :line 201, :end-line 213, :hash "-1072482116"} {:id "defn/expand-pageload", :kind "defn", :line 215, :end-line 218, :hash "1118200052"} {:id "defn/record-collapsed-pageload", :kind "defn", :line 220, :end-line 221, :hash "1572303210"} {:id "defn/record-event-for-pageload", :kind "defn", :line 223, :end-line 226, :hash "1940684709"} {:id "defn/render-timeline-expanded-state", :kind "defn", :line 228, :end-line 232, :hash "-1045715902"} {:id "defn/pageload-expanded?", :kind "defn", :line 234, :end-line 243, :hash "1211539265"} {:id "defn/event-visible-without-reexpanding?", :kind "defn", :line 245, :end-line 256, :hash "-1328095892"} {:id "def/forbidden-timeline-capability-patterns", :kind "def", :line 258, :end-line 264, :hash "1179421373"} {:id "defn/forbidden-timeline-capability-findings", :kind "defn", :line 266, :end-line 267, :hash "181573916"} {:id "defn-/inspect-timeline-implementation", :kind "defn-", :line 269, :end-line 273, :hash "-1945393687"} {:id "defn-/first-visible-entry", :kind "defn-", :line 275, :end-line 276, :hash "-2031728269"} {:id "defn-/example-value-or", :kind "defn-", :line 278, :end-line 279, :hash "-1940368029"} {:id "defn-/default-payload-label", :kind "defn-", :line 281, :end-line 282, :hash "1878071429"} {:id "defn-/default-raw-label", :kind "defn-", :line 284, :end-line 285, :hash "-953873882"} {:id "defn-/example-entry-options", :kind "defn-", :line 287, :end-line 297, :hash "-503844579"} {:id "defn/forbidden-timeline-capability-findings-of-kind", :kind "defn", :line 299, :end-line 300, :hash "-317346489"} {:id "defn/nested-timeline-wired?", :kind "defn", :line 302, :end-line 308, :hash "1463466039"} {:id "def/tuple-event-display-wired?", :kind "def", :line 310, :end-line 310, :hash "-862063050"} {:id "defn/timeline-expanded-state-wired?", :kind "defn", :line 312, :end-line 319, :hash "-1105305408"} {:id "defn-/property-item", :kind "defn-", :line 321, :end-line 323, :hash "1550456326"} {:id "def/handlers", :kind "def", :line 325, :end-line 708, :hash "1607767394"}]}
