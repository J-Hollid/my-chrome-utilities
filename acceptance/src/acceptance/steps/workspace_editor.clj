...
;; {:version 1, :tested-at "2026-09-07T15:13:12.253954674+02:00", :module-hash "1674329667", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "1978799929"} {:id "defn-/inspect", :kind "defn-", :line 5, :end-line 14, :hash "865105730"} {:id "defn/tabs-wired?", :kind "defn", :line 16, :end-line 22, :hash "-1561432839"} {:id "defn/workspace-headings?", :kind "defn", :line 24, :end-line 27, :hash "1235858867"} {:id "defn/editor-wired?", :kind "defn", :line 29, :end-line 34, :hash "-1153408800"} {:id "defn-/require-wiring", :kind "defn-", :line 36, :end-line 39, :hash "-148584365"} {:id "defn-/command-id", :kind "defn-", :line 41, :end-line 41, :hash "-316749086"} {:id "defn-/sequence", :kind "defn-", :line 42, :end-line 42, :hash "-1899006383"} {:id "def/workspace-tab-labels", :kind "def", :line 43, :end-line 43, :hash "954809956"} {:id "def/workspace-navigation-keys", :kind "def", :line 44, :end-line 44, :hash "-1593744239"} {:id "defn-/workspace-tab-label", :kind "defn-", :line 46, :end-line 50, :hash "-644152035"} {:id "defn-/workspace-navigation-key", :kind "defn-", :line 52, :end-line 56, :hash "1687996369"} {:id "defn-/workspace-navigation-destination", :kind "defn-", :line 58, :end-line 63, :hash "-856399467"} {:id "form/13/defonce", :kind "defonce", :line 65, :end-line 65, :hash "-2144812567"} {:id "defn-/load-workspace-panel-containment!", :kind "defn-", :line 67, :end-line 73, :hash "2025129671"} {:id "defn-/workspace-panel-containment!", :kind "defn-", :line 75, :end-line 76, :hash "-1306523167"} {:id "def/handlers", :kind "def", :line 78, :end-line 241, :hash "-1212376968"}]}
