...
(def ^:private scenario-assertion-fragments
  [[:created ["blank project" "contextual editor"]]
   [:search ["search"]]
   [:bulk ["bulk" "100 valid"]]
   [:release ["release dialog" "release gate" "atomic release"]]
   [:documentation ["documentation" "clipboard"]]
   [:flow ["flow editor" "flow step" "flow instance" "journey"]]
...
;; {:version 1, :tested-at "2026-07-18T22:21:59.864300104+02:00", :module-hash "1541803618", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-38261127"} {:id "defn-/assert-created!", :kind "defn-", :line 5, :end-line 6, :hash "741343283"} {:id "defn-/assert-search!", :kind "defn-", :line 7, :end-line 8, :hash "356890520"} {:id "defn-/assert-bulk!", :kind "defn-", :line 9, :end-line 10, :hash "660199247"} {:id "defn-/assert-release!", :kind "defn-", :line 11, :end-line 12, :hash "1754877658"} {:id "defn-/assert-layout!", :kind "defn-", :line 13, :end-line 14, :hash "-2069501695"} {:id "defn-/assert-documentation!", :kind "defn-", :line 15, :end-line 16, :hash "1820971250"} {:id "defn-/assert-flow!", :kind "defn-", :line 17, :end-line 18, :hash "1232678231"} {:id "defn-/assert-assignment!", :kind "defn-", :line 19, :end-line 20, :hash "1523199377"} {:id "defn-/assert-decisive!", :kind "defn-", :line 21, :end-line 22, :hash "1149966125"} {:id "defn-/assert-editor!", :kind "defn-", :line 23, :end-line 24, :hash "-1766293860"} {:id "defn-/assert-coverage!", :kind "defn-", :line 25, :end-line 26, :hash "1684807517"} {:id "defn-/assert-save-failure!", :kind "defn-", :line 27, :end-line 33, :hash "906691435"} {:id "defn-/assert-atomic-rollback!", :kind "defn-", :line 34, :end-line 38, :hash "-939091929"} {:id "defn-/assert-conflict-resolution!", :kind "defn-", :line 39, :end-line 47, :hash "1483489936"} {:id "defn-/assert-review!", :kind "defn-", :line 48, :end-line 49, :hash "-2125047744"} {:id "defn-/assert-import!", :kind "defn-", :line 50, :end-line 51, :hash "1071268371"} {:id "defn-/assert-responsive!", :kind "defn-", :line 52, :end-line 53, :hash "-1345004481"} {:id "defn-/assert-continuation!", :kind "defn-", :line 54, :end-line 61, :hash "363590485"} {:id "defn/assert-runtime!", :kind "defn", :line 63, :end-line 82, :hash "2009329272"} {:id "def/scenario-assertion-fragments", :kind "def", :line 84, :end-line 100, :hash "-1638515872"} {:id "def/scenario-assertions", :kind "def", :line 102, :end-line 119, :hash "2033548237"} {:id "defn-/includes-any?", :kind "defn-", :line 121, :end-line 122, :hash "1961528539"} {:id "defn-/decisive-scenario?", :kind "defn-", :line 124, :end-line 126, :hash "-894856329"} {:id "defn-/scenario-assertion-labels", :kind "defn-", :line 128, :end-line 135, :hash "-957049303"} {:id "defn/assert-runtime-scenario!", :kind "defn", :line 137, :end-line 145, :hash "-2090900873"}]}
