...
(def runtime-evidence-keys
  (set (map #(keyword (format "runtime%03d" %)) (range 1 52))))
...
(def flow002-examples
  {["3"] :small-entity-set
   ["300"] :large-entity-set})
(def flow019-examples
  {[:model ["the selection" "horizontally"]] :model-selection-horizontal
   [:model ["the selection" "vertically"]] :model-selection-vertical
   [:model ["Checkout Section" "horizontally"]] :model-section-horizontal
   [:model ["Checkout Section" "vertically"]] :model-section-vertical
   [:runtime ["selection" "horizontally"]] :runtime-selection-horizontal
   [:runtime ["selection" "vertically"]] :runtime-selection-vertical
   [:runtime ["Checkout Section" "horizontally"]] :runtime-section-horizontal
   [:runtime ["Checkout Section" "vertically"]] :runtime-section-vertical})
(def flow020-examples
  {["360" "800"] :narrow-viewport
   ["1440" "900"] :wide-viewport})
...
(defn flow019-example-key [mode example]
  (when (support/example-value example "arrangement")
    (support/assert! (contains? #{:model :runtime} mode) "Unknown Flow 019 evidence mode." {:mode mode})
    (let [row (mapv #(support/example-value example %) ["scope" "arrangement"])
          key [mode row]]
      (support/assert! (contains? flow019-examples key) "Unknown Flow 019 Tidy example." {:mode mode :row row})
      (get flow019-examples key))))
...
(defn validate-example! [mode example]
  ...
  (flow019-example-key mode example)
...
;; {:version 1, :tested-at "2026-08-22T19:43:07.76225297+02:00", :module-hash "1161323868", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 6, :hash "1962047470"} {:id "def/feature-files", :kind "def", :line 8, :end-line 10, :hash "-435723109"} {:id "def/entry-modes", :kind "def", :line 11, :end-line 13, :hash "-1332460073"} {:id "form/3/defonce", :kind "defonce", :line 14, :end-line 14, :hash "344781070"} {:id "form/4/defonce", :kind "defonce", :line 15, :end-line 15, :hash "-1618529344"} {:id "defn-/checked-command!", :kind "defn-", :line 17, :end-line 20, :hash "1232323377"} {:id "defn-/verify-model!", :kind "defn-", :line 21, :end-line 31, :hash "-17233573"} {:id "defn-/true-leaf-paths", :kind "defn-", :line 32, :end-line 43, :hash "222964114"} {:id "defn-/target-partitions", :kind "defn-", :line 44, :end-line 48, :hash "-1112341977"} {:id "defn-/parse-target-line", :kind "defn-", :line 49, :end-line 50, :hash "-345330627"} {:id "defn-/observe-target-line", :kind "defn-", :line 51, :end-line 60, :hash "-1549492299"} {:id "defn-/observed-targets", :kind "defn-", :line 61, :end-line 63, :hash "1686531439"} {:id "defn-/observe-browser!", :kind "defn-", :line 64, :end-line 83, :hash "1426689567"} {:id "def/runtime-evidence-keys", :kind "def", :line 84, :end-line 85, :hash "-1062596807"} {:id "def/required-evidence-keys", :kind "def", :line 86, :end-line 86, :hash "-1295581414"} {:id "def/flow001-examples", :kind "def", :line 87, :end-line 91, :hash "-1929769532"} {:id "def/flow002-examples", :kind "def", :line 92, :end-line 94, :hash "-1224043057"} {:id "def/flow019-examples", :kind "def", :line 95, :end-line 103, :hash "1534384051"} {:id "def/flow020-examples", :kind "def", :line 104, :end-line 106, :hash "753866774"} {:id "def/flow005-examples", :kind "def", :line 107, :end-line 121, :hash "-1087909857"} {:id "def/runtime009-examples", :kind "def", :line 122, :end-line 126, :hash "-167167521"} {:id "def/runtime010-examples", :kind "def", :line 127, :end-line 130, :hash "49886018"} {:id "def/runtime023-examples", :kind "def", :line 131, :end-line 133, :hash "-1984771249"} {:id "def/runtime024-examples", :kind "def", :line 134, :end-line 135, :hash "1058329484"} {:id "def/flow026-examples", :kind "def", :line 136, :end-line 138, :hash "-1147461739"} {:id "def/flow027-examples", :kind "def", :line 139, :end-line 149, :hash "-1245513417"} {:id "def/runtime027-examples", :kind "def", :line 150, :end-line 160, :hash "1138963094"} {:id "def/flow028-examples", :kind "def", :line 161, :end-line 164, :hash "1061929438"} {:id "def/flow029-examples", :kind "def", :line 165, :end-line 168, :hash "717686548"} {:id "def/flow048-examples", :kind "def", :line 169, :end-line 176, :hash "275187817"} {:id "def/flow050-examples", :kind "def", :line 177, :end-line 179, :hash "1589737778"} {:id "defn-/exact-example-key", :kind "defn-", :line 180, :end-line 184, :hash "-1670933730"} {:id "defn/flow005-example-key", :kind "defn", :line 185, :end-line 190, :hash "1749731827"} {:id "defn/flow001-example-key", :kind "defn", :line 191, :end-line 194, :hash "966521447"} {:id "defn/flow002-example-key", :kind "defn", :line 195, :end-line 196, :hash "1920675767"} {:id "defn/flow019-example-key", :kind "defn", :line 197, :end-line 203, :hash "-726217783"} {:id "defn/flow020-example-key", :kind "defn", :line 204, :end-line 207, :hash "251103203"} {:id "defn/runtime009-example-key", :kind "defn", :line 208, :end-line 212, :hash "1897394456"} {:id "defn/runtime010-example-key", :kind "defn", :line 213, :end-line 216, :hash "608325806"} {:id "defn/runtime023-example-key", :kind "defn", :line 217, :end-line 218, :hash "-1160499936"} {:id "defn/runtime024-example-key", :kind "defn", :line 219, :end-line 220, :hash "1247866732"} {:id "defn/flow026-example-key", :kind "defn", :line 221, :end-line 227, :hash "1303746130"} {:id "defn/runtime027-example-key", :kind "defn", :line 228, :end-line 231, :hash "-2025668393"} {:id "defn/flow028-example-key", :kind "defn", :line 232, :end-line 235, :hash "1401275215"} {:id "defn/flow029-example-key", :kind "defn", :line 236, :end-line 240, :hash "2100596702"} {:id "defn/flow048-example-key", :kind "defn", :line 241, :end-line 248, :hash "1482632242"} {:id "defn/flow050-example-key", :kind "defn", :line 249, :end-line 254, :hash "-453419916"} {:id "defn/validate-example!", :kind "defn", :line 255, :end-line 271, :hash "435029004"} {:id "defn/all-true?", :kind "defn", :line 272, :end-line 273, :hash "-1457866025"} {:id "defn/complete-browser-evidence?", :kind "defn", :line 274, :end-line 278, :hash "1699874411"} {:id "defn-/assert-runtime!", :kind "defn-", :line 279, :end-line 287, :hash "-1300859617"} {:id "def/handlers", :kind "def", :line 289, :end-line 293, :hash "89345785"}]}
