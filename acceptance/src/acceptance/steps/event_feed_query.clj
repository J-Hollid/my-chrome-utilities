...
(defn- load-observation! []
  (let [result (support/verified-command-result "node" "test/data-layer-event-feed-query-ui-test.mjs")
...
;; {:version 1, :tested-at "2026-08-04T11:33:29.874265007+02:00", :module-hash "1518834483", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line nil, :hash "-1354257905"} {:id "def/feature-files", :kind "def", :line 7, :end-line nil, :hash "768548319"} {:id "form/2/defonce", :kind "defonce", :line 8, :end-line nil, :hash "-1819867165"} {:id "def/query-case-identity", :kind "def", :line 10, :end-line nil, :hash "1937619230"} {:id "def/rule-outcome-matches", :kind "def", :line 11, :end-line nil, :hash "-108913877"} {:id "defn-/load-observation!", :kind "defn-", :line 18, :end-line nil, :hash "1815032909"} {:id "defn-/observation!", :kind "defn-", :line 31, :end-line nil, :hash "-775394783"} {:id "defn-/find-case", :kind "defn-", :line 33, :end-line nil, :hash "561822822"} {:id "defn-/assert-query-example!", :kind "defn-", :line 36, :end-line nil, :hash "179076316"} {:id "defn-/assert-rule-outcome-example!", :kind "defn-", :line 45, :end-line nil, :hash "1997161083"} {:id "defn-/assert-example!", :kind "defn-", :line 53, :end-line nil, :hash "934895631"} {:id "defn-/assert-observation!", :kind "defn-", :line 57, :end-line nil, :hash "83200658"} {:id "defn-/transition", :kind "defn-", :line 128, :end-line nil, :hash "-1692133953"} {:id "def/handlers", :kind "def", :line 131, :end-line nil, :hash "857296873"}]}
