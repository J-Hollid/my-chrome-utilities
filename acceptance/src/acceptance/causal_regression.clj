...
(defn emit!
  ([fixture-key observed]
   (emit! fixture-key observed nil))
  ([fixture-key observed task-local-definition]
   (when-let [encoded-context (System/getenv "SWARMFORGE_TIMEOUT_REPAIR_REGRESSION")]
     (let [context (json/parse-string encoded-context true)
           definition (or task-local-definition (fixture-definition fixture-key))]
