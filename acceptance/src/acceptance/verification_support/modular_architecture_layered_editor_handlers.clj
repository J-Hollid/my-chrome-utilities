...
(defn- boundary-handlers [example-values verify-throughput!]
  [{:pattern #"^(.+) currently belongs to the combined canonical_schema_editor boundary$"
   ...
   {:pattern #"^every one of the 32 current editor files and 85 Layered Schema files matches exactly one boundary$"
    :handler (fn [world _ _]
...
(defn- multi-change-handlers [example-values verify-throughput!]
  [
   ...
   {:pattern #"^all 19 Layered Schema unit files, 13 property files, and the exact shared-profile feature and handler evidence remain selected$"
    :handler (fn [world _ _]
               (let [plan (:vtd005/plan world)]
                 (assert-vtd005! world (and (= [19 13] [(:unit plan) (:property plan)])
...
(defn- conservation-handlers [verify-throughput!]
  [
   ...
   {:pattern #"^the 52-task exact owner plan retains one build, 19 unit tasks, 13 property tasks, four browser sessions containing all eight logical targets, seven parses, seven generators, and one acceptance session$"
    :handler (fn [world _ _]
               (let [c (get-in world [:vtd005/evidence :conservation])]
                 (assert-vtd005! world (= [52 1 19 13 4 8 7 7 1]
...
;; {:version 1, :tested-at "2026-08-07T23:46:20.235745462+02:00", :module-hash "145063610", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-1301353899"} {:id "def/target-labels", :kind "def", :line 5, :end-line 11, :hash "-1715132242"} {:id "defn-/values", :kind "defn-", :line 13, :end-line 15, :hash "-170718585"} {:id "defn-/expected-targets", :kind "defn-", :line 17, :end-line 20, :hash "-1792124582"} {:id "defn-/assert-vtd005!", :kind "defn-", :line 22, :end-line 24, :hash "128925372"} {:id "defn-/prepared", :kind "defn-", :line 26, :end-line 27, :hash "-1580254601"} {:id "defn-/path-plan", :kind "defn-", :line 29, :end-line 30, :hash "1272694595"} {:id "defn-/change-paths", :kind "defn-", :line 32, :end-line 33, :hash "-1536394027"} {:id "defn-/seconds", :kind "defn-", :line 35, :end-line 36, :hash "1741773050"} {:id "defn-/merged-plan", :kind "defn-", :line 38, :end-line 45, :hash "1754148101"} {:id "defn-/history-key", :kind "defn-", :line 47, :end-line 53, :hash "-256925796"} {:id "defn-/boundary-handlers", :kind "defn-", :line 55, :end-line 83, :hash "1499863381"} {:id "defn-/multi-change-handlers", :kind "defn-", :line 85, :end-line 113, :hash "2084762756"} {:id "defn-/conservation-handlers", :kind "defn-", :line 115, :end-line 148, :hash "-634350557"} {:id "defn-/history-handlers", :kind "defn-", :line 150, :end-line 172, :hash "-945026216"} {:id "defn-/sample-calibration-handlers", :kind "defn-", :line 174, :end-line 191, :hash "-1100059800"} {:id "defn-/boundary-budget-handlers", :kind "defn-", :line 193, :end-line 212, :hash "-785351219"} {:id "defn-/calibration-provenance-handlers", :kind "defn-", :line 214, :end-line 224, :hash "1072003465"} {:id "defn-/representative-calibration-handlers", :kind "defn-", :line 226, :end-line 264, :hash "-600491580"} {:id "defn/handlers", :kind "defn", :line 266, :end-line 275, :hash "-1053192435"}]}
