(ns acceptance.verification-support.modular-architecture-vtd007-handlers
  (:require [acceptance.steps.support :as support]
            ...
            [acceptance.verification-support.modular-architecture-vtd007-retirement-conservation :as retirement-conservation]
  ...
  (let [characterization (json/parse-string (slurp "verification/flow-examples-characterization.json"))
    ...
    {:characterization characterization
     ...
     :calibration-conserved? (and (zero? (:exit base-result))
                                  (= (retirement-conservation/calibration-projection base)
                                     (retirement-conservation/calibration-projection current))
                                  (str/blank? characterization-diff))
     :retired-receipt-evidence-excluded?
     (retirement-conservation/evidence-excluded? base current)}))
...
(defn- verify-conservation! [{:keys [characterization src-diff characterization-diff
  ...
  (retirement-conservation/emit! calibration-conserved?
                                 retired-receipt-evidence-excluded?)
...
;; {:version 1, :tested-at "2026-08-21T13:37:20.120345803+02:00", :module-hash "407265153", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 7, :hash "-360540908"} {:id "def/specification-commit", :kind "def", :line 9, :end-line 9, :hash "-916954367"} {:id "def/delivery-commit", :kind "def", :line 10, :end-line 10, :hash "-1771680097"} {:id "form/3/defonce", :kind "defonce", :line 12, :end-line 12, :hash "-968019553"} {:id "form/4/defonce", :kind "defonce", :line 13, :end-line 13, :hash "-1965273655"} {:id "def/migrated-entry-points", :kind "def", :line 15, :end-line 20, :hash "-1995674027"} {:id "def/deadline-production-boundaries", :kind "def", :line 22, :end-line 27, :hash "310858959"} {:id "defn-/assert!", :kind "defn-", :line 29, :end-line 30, :hash "-398636236"} {:id "defn-/shell-pack", :kind "defn-", :line 32, :end-line 33, :hash "359235976"} {:id "defn-/topology-ownership", :kind "defn-", :line 35, :end-line 63, :hash "-332695537"} {:id "defn-/topology-conserves-baseline?", :kind "defn-", :line 65, :end-line 68, :hash "-586173142"} {:id "defn-/run-production-probes!", :kind "defn-", :line 70, :end-line 90, :hash "297033765"} {:id "defn-/registry-context!", :kind "defn-", :line 92, :end-line 102, :hash "627475853"} {:id "defn-/source-context", :kind "defn-", :line 104, :end-line 111, :hash "-806855629"} {:id "defn-/verify-source-context!", :kind "defn-", :line 113, :end-line 141, :hash "1314332806"} {:id "defn-/conservation-context!", :kind "defn-", :line 143, :end-line 159, :hash "-783947651"} {:id "defn-/verify-conservation!", :kind "defn-", :line 161, :end-line 170, :hash "-1642427299"} {:id "def/surface-contracts", :kind "def", :line 172, :end-line 194, :hash "-1480752749"} {:id "defn-/contract-value-matches?", :kind "defn-", :line 196, :end-line 199, :hash "-1071455076"} {:id "defn-/surface-production-valid?", :kind "defn-", :line 201, :end-line 205, :hash "1901151494"} {:id "defn-/real-timing-valid?", :kind "defn-", :line 207, :end-line 212, :hash "974098377"} {:id "def/flow-phase-names", :kind "def", :line 214, :end-line 216, :hash "29062579"} {:id "def/flow-applicable-phases", :kind "def", :line 218, :end-line 219, :hash "1398007349"} {:id "def/installed-phase-names", :kind "def", :line 221, :end-line 223, :hash "-1213941958"} {:id "def/installed-applicable-phases", :kind "def", :line 225, :end-line 226, :hash "2060640483"} {:id "def/plan-conservation-program", :kind "def", :line 228, :end-line 245, :hash "-1118927580"} {:id "defn-/plan-conservation-evidence!", :kind "defn-", :line 247, :end-line 258, :hash "-1728767424"} {:id "defn-/verify-production-boundary!", :kind "defn-", :line 260, :end-line 295, :hash "-1307155565"} {:id "form/28/defonce", :kind "defonce", :line 297, :end-line 297, :hash "-1082635773"} {:id "defn-/values", :kind "defn-", :line 299, :end-line 301, :hash "-170718585"} {:id "defn-/ready", :kind "defn-", :line 303, :end-line 304, :hash "-94748577"} {:id "defn-/assert-world", :kind "defn-", :line 306, :end-line 308, :hash "1946856374"} {:id "defn-/evidence", :kind "defn-", :line 310, :end-line 311, :hash "1967727520"} {:id "defn-/deadline-row", :kind "defn-", :line 313, :end-line 315, :hash "-717451063"} {:id "defn-/readiness-row", :kind "defn-", :line 317, :end-line 320, :hash "429199432"} {:id "defn-/readiness-handlers", :kind "defn-", :line 322, :end-line 372, :hash "1464087763"} {:id "defn-/surface-handlers", :kind "defn-", :line 374, :end-line 407, :hash "-372148346"} {:id "defn-/timing-handlers", :kind "defn-", :line 409, :end-line 458, :hash "-1315948997"} {:id "defn-/deadline-boundary-handlers", :kind "defn-", :line 460, :end-line 484, :hash "-228980995"} {:id "defn-/deadline-diagnostic-handlers", :kind "defn-", :line 486, :end-line 507, :hash "-1654390828"} {:id "defn-/program-handlers", :kind "defn-", :line 509, :end-line 543, :hash "-1582657338"} {:id "defn-/conservation-handlers", :kind "defn-", :line 545, :end-line 558, :hash "-664374968"} {:id "defn/handlers", :kind "defn", :line 560, :end-line 567, :hash "1380409147"}]}
