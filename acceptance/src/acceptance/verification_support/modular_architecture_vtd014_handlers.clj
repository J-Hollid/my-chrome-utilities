...
(defn- universal-prerequisite-style-handlers [example-values]
  (style-authorization/handlers
   {:example-values example-values
    :stylesheet-boundaries stylesheet-boundaries
    :prepared prepared
    :values values
    :style-evidence style-evidence
    :assert-world! assert!}))
...
(defn- planner-projection-handlers [example-values]
  [{:pattern #"^(?:one governed review-evidence receipt contains a canonical browser batch and an alias-filtered prerequisite batch that both fail on the same single logical target|an unresolved browser incident needs a same-target planner projection|checkpoint prerequisite closure selects browser batches with overlapping logical targets or alias-only identity differences|a governed repair-focused preflight has one current incident whose bounded causal repair is ready|an inherited browser incident has an eligible repair and a terminal-verification-deferred disposition|that inherited incident diagnoses one target which appears in exactly one current canonical task|its receipt-bound same-target planner projection reports a changed historical-to-current target boundary|unresolved task succession is validated for the current repair plan)$"
   ...
   {:pattern #"^repair remains blocked with (.+)$"
    :applies? #(= "Modular verification packs 162" (:acceptance/scenario-name %))
...
;; {:version 1, :tested-at "2026-09-12T17:44:34.643781734+02:00", :module-hash "-1959658187", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 8, :hash "1363919429"} {:id "form/1/defonce", :kind "defonce", :line 10, :end-line 10, :hash "701185655"} {:id "form/2/defonce", :kind "defonce", :line 11, :end-line 11, :hash "1721954283"} {:id "form/3/defonce", :kind "defonce", :line 12, :end-line 12, :hash "-1385234094"} {:id "form/4/defonce", :kind "defonce", :line 13, :end-line 13, :hash "115416156"} {:id "defn-/production-evidence!", :kind "defn-", :line 15, :end-line 45, :hash "-1348377588"} {:id "defn-/prepared", :kind "defn-", :line 47, :end-line 48, :hash "897770149"} {:id "defn-/assert!", :kind "defn-", :line 50, :end-line 52, :hash "1408472967"} {:id "defn-/values", :kind "defn-", :line 54, :end-line 56, :hash "-170718585"} {:id "defn-/evidence-value", :kind "defn-", :line 58, :end-line 59, :hash "-1196778"} {:id "defn-/row-value", :kind "defn-", :line 61, :end-line 64, :hash "-798336634"} {:id "defn-/style-evidence", :kind "defn-", :line 66, :end-line 74, :hash "2050604925"} {:id "def/stylesheet-boundaries", :kind "def", :line 76, :end-line 80, :hash "1844180491"} {:id "def/promotion-scope-keys", :kind "def", :line 82, :end-line 86, :hash "20412880"} {:id "def/prerequisite-routes", :kind "def", :line 88, :end-line 91, :hash "-1618706903"} {:id "def/prerequisite-task-contract", :kind "def", :line 93, :end-line 99, :hash "-1735351185"} {:id "def/focused-verification-kinds", :kind "def", :line 101, :end-line 107, :hash "52068695"} {:id "def/repair-predecessor-contract", :kind "def", :line 109, :end-line 112, :hash "-641238058"} {:id "def/runner-mode-contract", :kind "def", :line 114, :end-line 120, :hash "118045761"} {:id "def/prerequisite-closure-contract", :kind "def", :line 122, :end-line 128, :hash "1116562715"} {:id "def/prerequisite-outcome-contract", :kind "def", :line 130, :end-line 142, :hash "1535624021"} {:id "def/failure-domain-contract", :kind "def", :line 144, :end-line 152, :hash "1449063263"} {:id "def/causal-incident-contract", :kind "def", :line 154, :end-line 158, :hash "-2086571635"} {:id "def/disposition-contract", :kind "def", :line 160, :end-line 176, :hash "1880553282"} {:id "def/input-equivalence-contract", :kind "def", :line 178, :end-line 184, :hash "-378171749"} {:id "def/flow-runner-modes", :kind "def", :line 186, :end-line 188, :hash "1707091140"} {:id "def/flow-readiness-contract", :kind "def", :line 190, :end-line 196, :hash "1486594103"} {:id "def/flow-classification-contract", :kind "def", :line 198, :end-line 204, :hash "578441815"} {:id "def/flow-causal-contract", :kind "def", :line 206, :end-line 210, :hash "-345339010"} {:id "def/task-succession-contract", :kind "def", :line 212, :end-line 227, :hash "465513991"} {:id "defn-/non-timeout-fixtures", :kind "defn-", :line 229, :end-line 231, :hash "1878657814"} {:id "def/retry-scopes", :kind "def", :line 233, :end-line 238, :hash "65095101"} {:id "def/retry-outcomes", :kind "def", :line 240, :end-line 244, :hash "-2097452382"} {:id "def/retry-outcome-keys", :kind "def", :line 246, :end-line 250, :hash "558321812"} {:id "def/repair-outcomes", :kind "def", :line 252, :end-line 262, :hash "1050890460"} {:id "def/incident-boundary-checks", :kind "def", :line 264, :end-line 273, :hash "-1679975384"} {:id "defn-/incident-boundary-exact?", :kind "defn-", :line 275, :end-line 276, :hash "1687152906"} {:id "def/diagnostic-scope-checks", :kind "def", :line 278, :end-line 286, :hash "892477097"} {:id "defn-/diagnostic-scope-exact?", :kind "defn-", :line 288, :end-line 289, :hash "1899816958"} {:id "defn-/incident-recording-handlers", :kind "defn-", :line 291, :end-line 299, :hash "-1244280115"} {:id "defn-/incident-identity-handlers", :kind "defn-", :line 301, :end-line 317, :hash "-1302661865"} {:id "defn-/diagnostic-scope-handlers", :kind "defn-", :line 319, :end-line 330, :hash "1635816000"} {:id "defn-/diagnostic-execution-handlers", :kind "defn-", :line 332, :end-line 346, :hash "346046064"} {:id "defn-/diagnostic-classification-handlers", :kind "defn-", :line 348, :end-line 355, :hash "1386450709"} {:id "defn-/diagnostic-result-handlers", :kind "defn-", :line 357, :end-line 373, :hash "-1100251734"} {:id "defn-/historical-timeout-handlers", :kind "defn-", :line 375, :end-line 386, :hash "435396237"} {:id "defn-/non-timeout-boundary-handlers", :kind "defn-", :line 388, :end-line 397, :hash "710300279"} {:id "defn-/non-timeout-classification-handlers", :kind "defn-", :line 399, :end-line 411, :hash "292096348"} {:id "defn-/non-timeout-repair-handlers", :kind "defn-", :line 413, :end-line 425, :hash "-809912869"} {:id "defn-/incident-handlers", :kind "defn-", :line 427, :end-line 437, :hash "-994233800"} {:id "def/repair-proposal-requirements", :kind "def", :line 439, :end-line 447, :hash "1991595942"} {:id "defn-/repair-proposal-observed?", :kind "defn-", :line 449, :end-line 451, :hash "1187360924"} {:id "defn-/repair-handlers", :kind "defn-", :line 453, :end-line 470, :hash "-1963388730"} {:id "defn-/store-handlers", :kind "defn-", :line 472, :end-line 507, :hash "1064536771"} {:id "defn-/prerequisite-handlers", :kind "defn-", :line 509, :end-line 614, :hash "-1216166419"} {:id "defn-/checkpoint-handlers", :kind "defn-", :line 616, :end-line 720, :hash "-2129198900"} {:id "defn-/universal-prerequisite-runner-handlers", :kind "defn-", :line 722, :end-line 749, :hash "-829449341"} {:id "defn-/universal-prerequisite-closure-handlers", :kind "defn-", :line 751, :end-line 782, :hash "-220190153"} {:id "defn-/universal-prerequisite-outcome-start-handlers", :kind "defn-", :line 784, :end-line 795, :hash "879109897"} {:id "defn-/universal-prerequisite-style-handlers", :kind "defn-", :line 797, :end-line 804, :hash "956914003"} {:id "defn-/universal-prerequisite-outcome-result-handlers", :kind "defn-", :line 806, :end-line 822, :hash "-1690054878"} {:id "defn-/universal-prerequisite-registry-handlers", :kind "defn-", :line 824, :end-line 859, :hash "-572634241"} {:id "defn-/universal-prerequisite-gate-handlers", :kind "defn-", :line 861, :end-line 867, :hash "-1239246060"} {:id "defn-/repair-prerequisite-handlers", :kind "defn-", :line 869, :end-line 895, :hash "-1391095503"} {:id "defn-/shared-boundary-handlers", :kind "defn-", :line 897, :end-line 946, :hash "98678608"} {:id "defn-/bounded-closure-contract-handlers", :kind "defn-", :line 948, :end-line 963, :hash "1543660532"} {:id "defn-/bounded-closure-domain-handlers", :kind "defn-", :line 965, :end-line 987, :hash "-1384182864"} {:id "defn-/bounded-closure-causal-handlers", :kind "defn-", :line 989, :end-line 1009, :hash "531095754"} {:id "defn-/bounded-closure-disposition-handlers", :kind "defn-", :line 1011, :end-line 1032, :hash "910151314"} {:id "defn-/bounded-closure-input-handlers", :kind "defn-", :line 1034, :end-line 1058, :hash "-547243501"} {:id "defn-/bounded-closure-terminal-handlers", :kind "defn-", :line 1060, :end-line 1088, :hash "806940813"} {:id "defn-/bounded-closure-handlers", :kind "defn-", :line 1090, :end-line 1096, :hash "-142063249"} {:id "defn-/flow-reload-lifecycle-handlers", :kind "defn-", :line 1098, :end-line 1163, :hash "1381085325"} {:id "defn-/flow-stylesheet-handlers", :kind "defn-", :line 1165, :end-line 1239, :hash "-927757738"} {:id "defn-/task-succession-change-handlers", :kind "defn-", :line 1241, :end-line 1257, :hash "-1744466407"} {:id "defn-/task-succession-governance-handlers", :kind "defn-", :line 1259, :end-line 1272, :hash "1677534015"} {:id "defn-/task-succession-mapping-handlers", :kind "defn-", :line 1274, :end-line 1291, :hash "-1926795259"} {:id "defn-/task-succession-integrity-handlers", :kind "defn-", :line 1293, :end-line 1310, :hash "460595661"} {:id "defn-/task-succession-handlers", :kind "defn-", :line 1312, :end-line 1316, :hash "246807726"} {:id "defn-/planner-projection-handlers", :kind "defn-", :line 1318, :end-line 1363, :hash "-1220650322"} {:id "def/run-intent-contract", :kind "def", :line 1365, :end-line 1369, :hash "-1375396036"} {:id "def/mutation-relations", :kind "def", :line 1371, :end-line 1474, :hash "326905174"} {:id "defn-/validate-mutation-relation!", :kind "defn-", :line 1476, :end-line 1479, :hash "447341592"} {:id "defn/priority-handlers", :kind "defn", :line 1481, :end-line 1531, :hash "-90433445"} {:id "defn-/run-intent-receipt-handlers", :kind "defn-", :line 1533, :end-line 1576, :hash "1991402901"} {:id "defn-/run-intent-bootstrap-handlers", :kind "defn-", :line 1578, :end-line 1638, :hash "1196998046"} {:id "defn-/run-intent-handlers", :kind "defn-", :line 1640, :end-line 1642, :hash "1493862866"} {:id "defn/handlers", :kind "defn", :line 1644, :end-line 1659, :hash "-585004147"}]}
