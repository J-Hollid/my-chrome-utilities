...
;; {:version 1, :tested-at "2026-08-27T18:17:12.98997865+02:00", :module-hash "-637687409", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 4, :hash "-83228735"} {:id "def/eight-pack-capture-closure", :kind "def", :line 6, :end-line 8, :hash "406707630"} {:id "def/seven-pack-dependant-closure", :kind "def", :line 10, :end-line 12, :hash "-1317336705"} {:id "def/handler-consumer-conditions", :kind "def", :line 14, :end-line 20, :hash "1697516706"} {:id "def/historical-changes", :kind "def", :line 22, :end-line 27, :hash "639407252"} {:id "def/historical-registry-states", :kind "def", :line 29, :end-line 30, :hash "-965054600"} {:id "def/event-library-targets", :kind "def", :line 32, :end-line 34, :hash "-478698114"} {:id "def/event-library-selections", :kind "def", :line 36, :end-line 40, :hash "978641701"} {:id "def/smoke-results", :kind "def", :line 42, :end-line 52, :hash "-1392652234"} {:id "defn-/event-world", :kind "defn-", :line 54, :end-line 55, :hash "-242776053"} {:id "defn-/assert-event!", :kind "defn-", :line 57, :end-line 59, :hash "-1013980911"} {:id "defn-/presentation-world", :kind "defn-", :line 61, :end-line 73, :hash "373451540"} {:id "defn-/handler-world", :kind "defn-", :line 75, :end-line 87, :hash "527272816"} {:id "defn-/side-panel-preparation-unit?", :kind "defn-", :line 89, :end-line 91, :hash "-1312840528"} {:id "defn-/conserved-evidence-profile", :kind "defn-", :line 93, :end-line 104, :hash "-1180534302"} {:id "defn-/conservation-world", :kind "defn-", :line 106, :end-line 121, :hash "1233047248"} {:id "defn-/calibration-world", :kind "defn-", :line 123, :end-line 142, :hash "-1460220513"} {:id "defn/handlers", :kind "defn", :line 144, :end-line 481, :hash "395356001"}]}
