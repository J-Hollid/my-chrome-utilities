...
(defn- representative-handlers [verify-throughput!]
  [{:pattern #"^src/workspace-tabs-ui.ts currently selects all 20 packs with dependant fan-out 19, critical-path baseline 510.8 seconds, and limit 613 seconds$"
   ...
   {:pattern #"^it selects only the complete 59-task property-enabled shell plan with dependant fan-out 0$"
    :handler (fn [world _ _]
               (assert! world (= 60 (evidence world :localPlan :tasks))
...
;; {:version 1, :tested-at "2026-08-08T12:23:31.902503172+02:00", :module-hash "728983516", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-1195833157"} {:id "defn-/values", :kind "defn-", :line 5, :end-line 7, :hash "-170718585"} {:id "defn-/ready", :kind "defn-", :line 9, :end-line 10, :hash "475939197"} {:id "defn-/assert!", :kind "defn-", :line 12, :end-line 14, :hash "-1557256114"} {:id "defn-/evidence", :kind "defn-", :line 16, :end-line 17, :hash "1303825807"} {:id "def/scopes", :kind "def", :line 19, :end-line 27, :hash "244864918"} {:id "defn-/scope", :kind "defn-", :line 29, :end-line 32, :hash "1976674990"} {:id "defn-/helper-handlers", :kind "defn-", :line 34, :end-line 62, :hash "-1623264261"} {:id "defn-/validation-handlers", :kind "defn-", :line 64, :end-line 86, :hash "-1764443311"} {:id "defn-/dormant-handlers", :kind "defn-", :line 88, :end-line 114, :hash "1798073499"} {:id "defn-/boundary-handlers", :kind "defn-", :line 116, :end-line 144, :hash "-318829380"} {:id "defn-/representative-handlers", :kind "defn-", :line 146, :end-line 172, :hash "-2000121832"} {:id "def/history-prefixes", :kind "def", :line 174, :end-line 179, :hash "-1907895100"} {:id "defn-/history-key", :kind "defn-", :line 181, :end-line 185, :hash "-153313306"} {:id "defn-/history-handlers", :kind "defn-", :line 187, :end-line 207, :hash "1079822317"} {:id "defn-/snapshot-handlers", :kind "defn-", :line 209, :end-line 259, :hash "-554645162"} {:id "defn/handlers", :kind "defn", :line 261, :end-line 268, :hash "1641483224"}]}
