               ...
               (let [inventory (get-in world [:vtd006/evidence :assertionLeafInventory])]
                 (assert! world
                          (and (= 64 (:targetCount inventory))
                               (= 7060 (:mappedLeafCount inventory))
