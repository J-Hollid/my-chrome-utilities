...
;; {:version 1, :tested-at "2026-08-09T02:41:20.890782692+02:00", :module-hash "-1203603621", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 3, :hash "-907446120"} {:id "def/human-pack-list", :kind "def", :line 5, :end-line 5, :hash "-401636353"} {:id "defn-/planned-browser-adapter-count", :kind "defn-", :line 7, :end-line 15, :hash "629369375"} {:id "defn-/boundary-handlers", :kind "defn-", :line 17, :end-line 53, :hash "-613878712"} {:id "defn-/owner-evidence-handlers", :kind "defn-", :line 55, :end-line 68, :hash "207716750"} {:id "defn-/isolation-handlers", :kind "defn-", :line 70, :end-line 100, :hash "456607937"} {:id "defn-/history-handlers", :kind "defn-", :line 102, :end-line 118, :hash "-1520439892"} {:id "defn-/conservation-handlers", :kind "defn-", :line 120, :end-line 146, :hash "-52418671"} {:id "defn-/calibration-handlers", :kind "defn-", :line 148, :end-line 178, :hash "1619012991"} {:id "defn/handlers", :kind "defn", :line 180, :end-line 186, :hash "-1970084541"}]}
