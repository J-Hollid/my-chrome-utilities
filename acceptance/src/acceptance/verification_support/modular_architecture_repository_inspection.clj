...
;; {:version 1, :tested-at "2026-08-08T12:18:58.239000118+02:00", :module-hash "-260914535", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 5, :hash "1927640464"} {:id "def/browser-adapter-modes", :kind "def", :line 7, :end-line 8, :hash "-1768145777"} {:id "defn/enough-verification-packs?", :kind "defn", :line 10, :end-line 11, :hash "1002135556"} {:id "defn-/classified-browser-adapters", :kind "defn-", :line 13, :end-line 16, :hash "1447896627"} {:id "defn-/inspection-context", :kind "defn-", :line 18, :end-line 30, :hash "-360551503"} {:id "defn-/assert-pack-fields!", :kind "defn-", :line 32, :end-line 37, :hash "-687209790"} {:id "defn-/assert-adapter-classifications!", :kind "defn-", :line 39, :end-line 47, :hash "-950151277"} {:id "defn-/assert-registered-paths!", :kind "defn-", :line 49, :end-line 53, :hash "1363454567"} {:id "defn-/assert-shared-adapters!", :kind "defn-", :line 55, :end-line 59, :hash "-1460578147"} {:id "defn-/assert-source-signals!", :kind "defn-", :line 61, :end-line 110, :hash "1212118136"} {:id "defn-/assert-owning-pack-batches!", :kind "defn-", :line 112, :end-line 122, :hash "1703688010"} {:id "defn-/assert-browser-batching!", :kind "defn-", :line 124, :end-line 136, :hash "1599646018"} {:id "defn-/assert-runtime-boundaries!", :kind "defn-", :line 138, :end-line 146, :hash "767574382"} {:id "defn-/inspect-repository!", :kind "defn-", :line 148, :end-line 156, :hash "-552939158"} {:id "defn/inspect!", :kind "defn", :line 158, :end-line 165, :hash "-1604167754"}]}
