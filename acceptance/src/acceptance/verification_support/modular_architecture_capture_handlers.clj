...
;; {:version 1, :tested-at "2026-08-24T16:10:28.337896195+02:00", :module-hash "2046599275", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 4, :hash "-1059637939"} {:id "def/ten-pack-closure", :kind "def", :line 6, :end-line 8, :hash "-1704477001"} {:id "defn-/capture-world", :kind "defn-", :line 10, :end-line 11, :hash "1110607245"} {:id "defn-/assert-capture!", :kind "defn-", :line 13, :end-line 15, :hash "703626744"} {:id "defn-/scope-label", :kind "defn-", :line 17, :end-line 21, :hash "27923472"} {:id "defn-/handler-path", :kind "defn-", :line 23, :end-line 24, :hash "-993126326"} {:id "def/historical-rename-keys", :kind "def", :line 26, :end-line 31, :hash "837699704"} {:id "defn-/historical-rename-key", :kind "defn-", :line 33, :end-line 36, :hash "199210269"} {:id "defn-/history-key", :kind "defn-", :line 38, :end-line 42, :hash "1018199717"} {:id "defn-/handler-evidence-world", :kind "defn-", :line 44, :end-line 53, :hash "-1761639346"} {:id "defn-/isolation-diagnostic-key", :kind "defn-", :line 55, :end-line 60, :hash "1351877771"} {:id "defn-/boundary-handlers", :kind "defn-", :line 62, :end-line 129, :hash "-474768067"} {:id "defn-/isolation-handlers", :kind "defn-", :line 131, :end-line 185, :hash "-1469317142"} {:id "defn-/history-handlers", :kind "defn-", :line 187, :end-line 211, :hash "1756899993"} {:id "defn-/conservation-handlers", :kind "defn-", :line 213, :end-line 255, :hash "1646060979"} {:id "defn-/calibration-handlers", :kind "defn-", :line 257, :end-line 301, :hash "1727232257"} {:id "defn/handlers", :kind "defn", :line 303, :end-line 308, :hash "1521527435"}]}
